...
export default {
  ...
  "navbar.community.comparison": "Comparison",
  ...
  // website
	...
	'home.hero.description.line1': 'Open-source AI Gateway for Agent development and LLM API management',
	...
	'home.gateway.solution.title': 'One Higress for Three Types of AI Traffic',
	'home.gateway.solution.description': 'Connect model APIs, MCP tools, and Kubernetes inference workloads through one gateway',
	'home.gateway.solution.source.title': 'AI Apps & Agents',
	'home.gateway.solution.source.description': 'One entry point',
	...
	'home.gateway.solution.lane.llm.description': 'Model API governance',
	'home.gateway.solution.lane.llm.feature1': 'Unified APIs',
	'home.gateway.solution.lane.llm.feature2': 'Token control',
	'home.gateway.solution.lane.llm.target': 'Model APIs',
	'home.gateway.solution.lane.mcp.title': 'MCP Gateway',
	'home.gateway.solution.lane.mcp.description': 'Tool-call governance',
	'home.gateway.solution.lane.mcp.feature1': 'MCP proxy',
	'home.gateway.solution.lane.mcp.feature2': 'Translation',
	...
	'home.gateway.solution.shared.security': 'Security',
	'home.gateway.solution.shared.governance': 'Traffic Governance',
	'home.gateway.solution.shared.observability': 'Observability',
    ...
    'ai.product.competitor_compare.title': 'Higress vs Other AI Gateways',
    ...
    'ai.product.competitor_compare.oneapi.core_function.higress': 'API Gateway with AI capabilities',
    'ai.product.competitor_compare.oneapi.maintenance': 'Maintenance',
    'ai.product.competitor_compare.oneapi.maintenance.oneapi': 'Individual-maintained project',
    'ai.product.competitor_compare.oneapi.maintenance.higress': 'Maintained by Alibaba Cloud API Gateway team',
    'ai.product.competitor_compare.oneapi.security': 'System Security',
    'ai.product.competitor_compare.oneapi.security.oneapi': 'Vulnerable to security issues, e.g., DockerHub image injection',
    'ai.product.competitor_compare.oneapi.security.higress': 'Commercial version managed by Alibaba Cloud, open source with container security scanning',
    'ai.product.competitor_compare.oneapi.content_safety': 'Content Safety',
    'ai.product.competitor_compare.oneapi.content_safety.oneapi': 'None',
    'ai.product.competitor_compare.oneapi.content_safety.higress': 'Integrated content security, real-time filtering & data masking',
    'ai.product.competitor_compare.oneapi.model_management': 'Model Management',
    'ai.product.competitor_compare.oneapi.model_management.oneapi': 'Basic model & API key configuration',
    'ai.product.competitor_compare.oneapi.model_management.higress': 'API Key pool, consumer management, fallback models, canary release',
    'ai.product.competitor_compare.oneapi.observability': 'Observability',
    'ai.product.competitor_compare.oneapi.observability.oneapi': 'None',
    'ai.product.competitor_compare.oneapi.observability.higress': 'Monitoring dashboard, Token analysis, latency tracking',
    ...
    'ai.product.competitor_compare.litellm.architecture.higress': 'API Gateway based, control & data plane separation, dynamic config',
    'ai.product.competitor_compare.litellm.load_balancing': 'Load Balancing',
    'ai.product.competitor_compare.litellm.load_balancing.litellm': 'Latency-based, Least-Busy, Rate-Limit Aware, Lowest Cost',
    'ai.product.competitor_compare.litellm.load_balancing.higress': 'All LiteLLM strategies + Intent-based load balancing',
    'ai.product.competitor_compare.litellm.retry_fallback': 'Retry/Fallback',
    'ai.product.competitor_compare.litellm.retry_fallback.litellm': 'Basic retry, cooldown and fallback',
    'ai.product.competitor_compare.litellm.retry_fallback.higress': 'Dual-layer cooldown (API Key + service instance), active health checks',
    'ai.product.competitor_compare.litellm.observability': 'Observability',
    'ai.product.competitor_compare.litellm.observability.litellm': 'LangFuse/LangSmith integration',
    'ai.product.competitor_compare.litellm.observability.higress': 'ARMS/SLS integration, OpenTelemetry protocol support',
    'ai.product.competitor_compare.litellm.self_hosted': 'Self-Hosted Models',
    'ai.product.competitor_compare.litellm.self_hosted.litellm': 'vllm, ollama, etc.',
    'ai.product.competitor_compare.litellm.self_hosted.higress': 'PAI EAS/vllm/ollama/sglang/xinference, OpenAI protocol compatible',
    'ai.product.competitor_compare.litellm.extensibility': 'Extensibility',
    'ai.product.competitor_compare.litellm.extensibility.litellm': '—',
    'ai.product.competitor_compare.litellm.extensibility.higress': 'Wasm plugins, multi-language support, zero-downtime hot reload',
    'ai.product.competitor_compare.litellm.usability': 'Usability',
    'ai.product.competitor_compare.litellm.usability.litellm': '—',
    'ai.product.competitor_compare.litellm.usability.higress': 'Out-of-box UI console',
    'ai.product.competitor_compare.litellm.security': 'Security',
    'ai.product.competitor_compare.litellm.security.litellm': '—',
    'ai.product.competitor_compare.litellm.security.higress': 'Content security, data masking, multiple auth strategies',
    ...
    'ai.product.competitor_compare.cta.docs': 'View Full Comparison',
    ...
    'ai.product.version_compare.exclusive.feature1': 'Performance & Resources: Match business scale with elastic scalability',
    'ai.product.version_compare.exclusive.feature2': 'SLA: Negotiable on demand with ultimate guarantee',
    'ai.product.version_compare.exclusive.feature3': 'Out-of-the-box advantages in stability, performance, cloud product integration, and usability over community edition',
    'ai.product.version_compare.exclusive.feature4': 'Unified proxy for AI model API and MCP Server with rich integration and governance capabilities',
    'ai.product.version_compare.exclusive.btn': 'Contact Us',
    'ai.product.version_compare.exclusive.tip': 'Ticket, DingTalk & offline commercial support',

...
export default {
  ...
  "navbar.community.comparison": "竞品对比",
	...
	'home.hero.description.line1': '开源 AI 网关，为 Agent 开发、LLM API 管理提供生产级能力',
	'home.hero.description.line2': '提供免费开源版与云上商业版，统一接入模型、工具和 MCP Server',
	'home.cncf.hero_badge': 'Sandbox Project',
	...
	'home.gateway.solution.title': '一个 Higress，统一治理三类 AI 流量',
	'home.gateway.solution.description': '统一接入模型 API、MCP 工具与 Kubernetes 推理工作负载',
	'home.gateway.solution.source.title': 'AI Apps & Agents',
	'home.gateway.solution.source.description': '统一入口',
	'home.gateway.solution.core.title': 'Higress AI Gateway',
	'home.gateway.solution.core.badge': 'ONE GATEWAY',
	'home.gateway.solution.lane.llm.title': 'LLM Gateway',
	'home.gateway.solution.lane.llm.description': '模型 API 治理',
	'home.gateway.solution.lane.llm.feature1': '统一协议',
	'home.gateway.solution.lane.llm.feature2': 'Token 治理',
	'home.gateway.solution.lane.llm.target': 'Model APIs',
	'home.gateway.solution.lane.mcp.title': 'MCP Gateway',
	'home.gateway.solution.lane.mcp.description': '工具调用治理',
	'home.gateway.solution.lane.mcp.feature1': 'MCP 代理',
	'home.gateway.solution.lane.mcp.feature2': '协议转换',
	'home.gateway.solution.lane.mcp.target': 'Tools & MCP Servers',
	'home.gateway.solution.lane.model.title': 'Model Gateway',
	'home.gateway.solution.lane.model.description': 'Gateway API Inference Extension',
	'home.gateway.solution.lane.model.feature1': 'InferencePool',
	'home.gateway.solution.lane.model.feature2': 'Endpoint Picker',
	'home.gateway.solution.lane.model.target': 'Inference Workloads',
	'home.gateway.solution.shared.security': '安全防护',
	'home.gateway.solution.shared.governance': '流量治理',
	'home.gateway.solution.shared.observability': '可观测',
    ...
    'ai.product.competitor_compare.title': 'Higress vs 其他 AI 网关',
    ...
    'ai.product.competitor_compare.oneapi.core_function.higress': '具有 AI 网关功能的 API 网关',
    'ai.product.competitor_compare.oneapi.maintenance': '维护方式',
    'ai.product.competitor_compare.oneapi.maintenance.oneapi': '由个人维护的项目',
    'ai.product.competitor_compare.oneapi.maintenance.higress': '由阿里云 API 网关团队维护',
    'ai.product.competitor_compare.oneapi.security': '系统安全',
    'ai.product.competitor_compare.oneapi.security.oneapi': '易受安全漏洞影响,如 DockerHub 镜像被注入加密挖矿脚本',
    'ai.product.competitor_compare.oneapi.security.higress': '商业版由阿里云托管,开源版集成容器镜像服务,提供安全扫描',
    'ai.product.competitor_compare.oneapi.content_safety': '内容安全',
    'ai.product.competitor_compare.oneapi.content_safety.oneapi': '无',
    'ai.product.competitor_compare.oneapi.content_safety.higress': '集成阿里云内容安全,实时内容过滤与数据脱敏',
    'ai.product.competitor_compare.oneapi.model_management': '模型管理',
    'ai.product.competitor_compare.oneapi.model_management.oneapi': '仅支持模型和 API Key 配置',
    'ai.product.competitor_compare.oneapi.model_management.higress': 'API Key 池管理、消费者管理、兜底模型、模型灰度',
    'ai.product.competitor_compare.oneapi.observability': '可观测性',
    'ai.product.competitor_compare.oneapi.observability.oneapi': '无',
    'ai.product.competitor_compare.oneapi.observability.higress': '监控仪表板、Token 消耗分析、延迟监控',
    ...
    'ai.product.competitor_compare.litellm.architecture.higress': '基于 API 网关,控制面与数据面分离,动态配置生效',
    'ai.product.competitor_compare.litellm.load_balancing': '负载均衡',
    'ai.product.competitor_compare.litellm.load_balancing.litellm': '支持延迟、最少忙碌、限流感知、最低成本等策略',
    'ai.product.competitor_compare.litellm.load_balancing.higress': '支持 LiteLLM 所有策略 + 基于意图的负载均衡',
    'ai.product.competitor_compare.litellm.retry_fallback': '重试/兜底',
    'ai.product.competitor_compare.litellm.retry_fallback.litellm': '支持 retry、cooldown 和 fallback,功能基础',
    'ai.product.competitor_compare.litellm.retry_fallback.higress': 'API Key 层面 + 服务实例层面双重 cooldown,主动健康检查',
    'ai.product.competitor_compare.litellm.observability': '可观测性',
    'ai.product.competitor_compare.litellm.observability.litellm': '支持对接 LangFuse/LangSmith',
    'ai.product.competitor_compare.litellm.observability.higress': '对接 ARMS/SLS,支持 OpenTelemetry 协议',
    'ai.product.competitor_compare.litellm.self_hosted': '自建模型',
    'ai.product.competitor_compare.litellm.self_hosted.litellm': '支持 vllm、ollama 等',
    'ai.product.competitor_compare.litellm.self_hosted.higress': '支持 PAI EAS/vllm/ollama/sglang/xinference,兼容 OpenAI 协议',
    'ai.product.competitor_compare.litellm.extensibility': '扩展性',
    'ai.product.competitor_compare.litellm.extensibility.litellm': '—',
    'ai.product.competitor_compare.litellm.extensibility.higress': 'Wasm 插件,支持多语言,流量无损热更新',
    'ai.product.competitor_compare.litellm.usability': '易用性',
    'ai.product.competitor_compare.litellm.usability.litellm': '—',
    'ai.product.competitor_compare.litellm.usability.higress': '开箱即用的 UI 控制台',
    'ai.product.competitor_compare.litellm.security': '安全',
    'ai.product.competitor_compare.litellm.security.litellm': '—',
    'ai.product.competitor_compare.litellm.security.higress': '内容安全、数据脱敏、多种认证鉴权策略',
    ...
    'ai.product.version_compare.exclusive.feature1': '性能与资源：匹配业务规模，弹性可伸缩',
    'ai.product.version_compare.exclusive.feature2': 'SLA：按需协商，极致保障',
    'ai.product.version_compare.exclusive.feature3': '开箱即用，在稳定性、性能、云产品集成和易用性上，比社区版更有优势',
    'ai.product.version_compare.exclusive.feature4': '统一代理大模型 API 和 MCP Server，并提供丰富的集成和治理能力',
    'ai.product.version_compare.exclusive.btn': '联系我们',
    'ai.product.version_compare.exclusive.tip': '工单、钉群、线下等商业服务支持',
    ...
    'glossary.search.placeholder': '搜索术语 (例如: Token, Wasm, 限流...)',
    'glossary.category.all': '全部',
    'glossary.stats.total': '共',
    'glossary.stats.terms': '个术语',
    'glossary.stats.categories': '大领域',
    'glossary.stats.covered': '覆盖',
    'glossary.no_results.title': '未找到匹配术语',
    'glossary.no_results.description': '换个关键词试试？或者在上方选择其他分类',

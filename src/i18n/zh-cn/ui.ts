...
export default {
	...
	'home.introduce.nacos.release.note.2': 'V1.4.1 的版本说明',
	...
	'home.website.edge.1.description': '为开发者提供了一站式的AI插件集和增强后端模型调度处理能力，使得AI与网关的集成更加便捷和高效。',
	'home.website.edge.2.title': '易于扩展',
	'home.website.edge.2.description': '提供丰富的官方插件库，涵盖AI、流量管理、安全防护等常用功能，满足90%以上的业务场景需求。主打Wasm插件扩展，支持多语言编写Wasm插件，插件更新采用热插拔机制对流量无损。',
	'home.website.edge.3.title': '遵循标准',
	'home.website.edge.3.description': '遵循Ingress、Gateway API 和 Istio API标准，可一键支持基于以上技术选型的其他网关平滑迁移。',
	'home.website.edge.4.title': 'API管理',
	'home.website.edge.4.description': '为开发者提供“API自省”功能，帮助开发者快速构建API开放能力，同时也提供JWT、OIDC等多种认证鉴权，满足一站式认证安全要求。',

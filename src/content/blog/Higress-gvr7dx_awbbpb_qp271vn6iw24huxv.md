...
<font style="color:rgb(13, 18, 57);">今天，由 Higress 社区和 Naocs 社区共同发起的全新开源项目 </font>**<font style="color:rgb(13, 18, 57);">HiMarket AI 开放平台</font>**<font style="color:rgb(13, 18, 57);">，正式发布。</font>
...
1. **<font style="color:rgb(13, 18, 57);">访问管理后台** localhost:5174 ，注册管理员账号。</font>
...
5. **<font style="color:rgb(13, 18, 57);">切换到开发者门户** ( localhost:5173 )，注册一个开发者账号，并等待管理员在后台审批通过。</font>

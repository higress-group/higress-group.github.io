...
+ **<font style="color:rgb(27, 28, 29);">语言 SDK</font>**<font style="color:rgb(27, 28, 29);">：为了简化开发，社区提供了特定语言的 SDK，例如 </font>`[https://github.com/higress-group/wasm-go](https://github.com/higress-group/wasm-go)`<font style="color:rgb(27, 28, 29);"> 。SDK 将底层的 ABI 细节进行了封装，让开发者可以用更符合语言习惯的方式编写插件逻辑 。这个 SDK 的使用可以参考这篇文档：</font>[https://higress.cn/docs/latest/user/wasm-go](https://higress.cn/docs/latest/user/wasm-go/?spm=higress-website.topbar.0.0.0)

---
title: AI 时代的开源官网长什么样？Higress 重构实录
keywords: [AI,Higress,Website,Refactor]
description: Higress 官网迎来全面升级，采用 Astro 5 + Starlight 技术栈，实现 AI 友好设计，性能优化，内容重塑，打造 AI 时代的开源官网新范式。
author: 丹坤
date: "2026-01-27"
category: "article"
---
...
> "你的官网，AI 能读懂吗？"当我第一次把 Higress 文档链接丢给 Claude，让它帮我写个接入 Demo 时，AI 的回复是：\_"抱歉，我无法有效解析这个页面的内容结构..."\_这一刻我意识到：**我们的文档，正在被时代淘汰。**

---

## TL;DR

*   🏗️ **技术栈大换血**：迁移到 Astro 5 + Starlight，Lighthouse 性能跑分 **100 分**
    
*   🤖 **AI 友好**：接入 llms.txt 标准，支持 Cursor、Claude Code 等 **主流 AI Coding 工具**
    
*   🧹 **极致瘦身**：AI 自动清理 **147 张无效图片**，产物体积大幅缩减
    
*   ⚡ **效率革命**：一个人 + Qoder + Skills，完成过去需要一个小组的工作量
    
*   🎯 **AI 全能助手**：设计稿转代码、资源自动清理、性能优化、SEO/CRO 专业分析、内容缺失智能补全 - **这些原本需要设计师、运维、SEO 专家、文案策划的工作，现在 AI 都能搞定**
...
[Higress](https://github.com/alibaba/higress) 作为 AI 时代的流量基础设施，经历了多次演进：
...
2.  **AI 阅读障碍**：随着 AI Coding 的深入使用，开发者趋向让 AI 阅读产品文档，然后编写 Demo 或者融入当前的业务逻辑。我们的产品官网不仅仅是给人阅读，更多需要考虑给 AI 阅读。
    
3.  **能力短板**：团队同学的过往工作经验一直在 B 端业务，官网首页是一个偏 C 端的场景。对于性能、SEO、样式效果要求和 B 端完全不一样。过去的这部分的工作经验非常少。
    

![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/3ff72f71-0e5d-43a2-b0e9-55fa2569ceba.webp)
...
原官网导航包含 7–8 个入口，信息冗余。我们精简为四大核心模块：

*   **核心产品**：API 网关、AI 网关、HiMarket 三大子产品，各有独立 Landing Page
    
*   **使用文档**：统一入口，重构导航与排版，支持跨产品切换
    
*   **企业版链接**：商业化专属通道
    
*   **社区 & 博客**：聚合开发者信息，降低参与门槛
    

#### 无障碍 & AI 友好设计

严格遵循 WCAG AA 标准：色彩对比度 ≥ 4.5:1，交互元素 ≥ 44×44px。Lighthouse Accessibility 达到 **100 分**。

#### 视觉与品牌表达

延续科技蓝主色与几何语言，以"降噪、聚焦、提效"为原则：

*   **克制排布**：减少装饰元素，聚焦核心内容
    
*   **统一结构**：产品页采用「功能简介 + 核心优势 + 企业版引流」标准结构
    
*   **差异表达**：产品页强化架构图，文档博客侧重结构化排版
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/50614cf8-b6fc-4cfa-87d1-73bd1f2fc9f8.webp)

### 让搜索引擎读懂你：SEO 优化策略

#### 结构化数据 Skill(Schema Markup)
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/30386bd6-bf98-4c8d-b3b7-9b0b9122be33.png)

执行优化：

由于优化项较多，Agent 容易遗忘，根据 [Manus 的经验](https://manus.im/zh-cn/blog/Context-Engineering-for-AI-Agents-Lessons-from-Building-Manus)，使用 todolist (add\_tasks) 工具进行任务管理。通过 prompt "使用 todolist 工具开始执行任务"，AI 会创建任务列表并逐一完成 Article、SoftwareApplication、Organization、WebSite 等 Schema 的优化。

![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Lk3lbmbo6ZKoXOm9/img/24601e0c-7468-47b3-aa91-8de596668d3d.png)

#### pSEO Skill:规模化构建高质量内容
...
作用：利用模板和数据大规模构建经过 SEO 优化的页面。⚠️ 注意，谨慎使用此 Skill 会批量制造垃圾页面，所有的页面都需要经过人工 Review。

给出的建议如下：

![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Lk3lbmbo6ZKoXOm9/img/cb8b8a24-be61-41d7-848a-5b8ae7f5a685.png)
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Lk3lbmbo6ZKoXOm9/img/290d9606-9f97-4c8c-8176-97d91715f6fa.png)
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Lk3lbmbo6ZKoXOm9/img/534a8dd2-c2de-4488-944a-f87970215af5.png)

**深度竞品对比**

效果：[https://higress.ai/comparison](https://higress.ai/comparison)

![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/f0652e64-ac25-4f71-a64d-42b70e0ba6be.png)

### 让用户爱上你：转化率优化策略

利用 `onboarding-cro` 和 `page-cro` Skills 对关键页面进行诊断优化。

#### 用户引导优化 Skill(Onboarding CRO)
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Lk3lbmbo6ZKoXOm9/img/e5ad6d0d-f673-43ec-994d-39e8a81cb3e0.png)

优化效果：

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/766df417-fc4f-455b-a90e-79299d167718.png)

AI 生成的审核报告会识别出首页在价值主张、CTA 层次、信任信号等方面的不足，并提供具体的优化方案。

#### 页面转化率优化 Skill(Page CRO)
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Lk3lbmbo6ZKoXOm9/img/e86565c2-4545-46f0-9fde-ff244cc617c6.png)
...
1.  快速部署引导
    ...
    ![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/feefb7c0-8bec-42c3-932b-18f1806ac197.png)
    
2.  竞对分析引导
    

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/954be6ca-3337-4976-b253-5ed680254acc.png)

### 让 AI 读懂你：AI 亲和优化策略

在 AI 时代，官网的受众正在发生变化。随着 AI Coding 的深入使用，开发者倾向于让 AI 阅读产品文档，然后编写 Demo 或融入业务逻辑。我们的产品官网**不仅仅是给人阅读，更需要考虑给 AI 阅读**。

#### llms.txt:为 AI 准备的文档入口
...
#### Markdown 结构化:AI 友好的内容格式

支持 复制为Markdown文本，以及支持 Makrdown链接。方便在AI Coding工具集成。

![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/29a5aa21-d4e7-453c-9414-8a6604d13d0b.gif)

## 04 效率革命：AI Coding 让我一人顶起一个开发组

有了 AI 这个"全能队友"，过去棘手的工程问题迎刃而解。

### Design2Code：从设计稿到代码的直达
...
网页还原： ![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/v9kqDejreEexpOVx/img/e4e8d811-506d-4173-bc18-f5bea7776d60.png)

### 代码"断舍离"：AI 帮我删掉 147 张废图
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/8oLl952vowyKylap/img/52df2404-3d31-4ee3-92b9-80b22b97e055.png)

### 从 65 分到 100 分：让 AI 自己优化性能

**效果：**

![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/Lk3lbmbo6ZKoXOm9/img/395e966e-7149-4fd2-b1e2-e8bf8e4b5b02.png)

安装 [chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) 工具，利用 AI 生成报告并自主执行优化。
...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/8oLl952vowyKylap/img/17dd9e4b-8e29-4ae1-8313-10080462b232.png)

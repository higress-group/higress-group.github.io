...
<a name="rH4kG"></a>
# AI 代理
官方文档：[https://help.aliyun.com/zh/mse/user-guide/ai-agent?spm=higress-website.topbar.0.0.0](https://help.aliyun.com/zh/mse/user-guide/ai-agent?spm=higress-website.topbar.0.0.0)
<a name="oHwbX"></a>
## 应用架构
...
<a name="aoQWd"></a>
# AI 可观测
官方文档：[https://help.aliyun.com/zh/mse/user-guide/ai-observable?spm=higress-website.topbar.0.0.0](https://help.aliyun.com/zh/mse/user-guide/ai-observable?spm=higress-website.topbar.0.0.0)
<a name="DguUr"></a>
## 应用架构
...
<a name="OnniO"></a>
# AI 内容安全
官方文档：[https://help.aliyun.com/zh/mse/user-guide/ai-content-security?spm=higress-website.topbar.0.0.0](https://help.aliyun.com/zh/mse/user-guide/ai-content-security?spm=higress-website.topbar.0.0.0)
<a name="aaqW1"></a>
## 应用架构
大模型通常是通过学习互联网上广泛可用的数据来训练的，它们有可能在过程中学习到并复现有害内容或不良言论，因此，当大模型未经过适当的过滤和监控就生成回应时，它们可能产生包含有害语言、误导信息、歧视性言论甚至是违反法律法规的内容。正是因为这种潜在的风险，大模型中的内容安全就显得异常重要。<br />基于AI内容安全插件，通过简单的配置即可对接[阿里云内容安全](https://help.aliyun.com/document_detail/28417.html?spm=higress-website.topbar.0.0.0)，为大模型问答的合规性保驾护航。<br />![](/img/1728551154645.png)<br />配置AI内容安全插件后，应用架构如下图所示：<br />![image.png](/img/1728551762859.png)
<a name="M186m"></a>
## 插件配置
...
<a name="nEKyA"></a>
# AI Token 限流
官方文档：[https://help.aliyun.com/zh/mse/user-guide/ai-token-current-limiting?spm=higress-website.topbar.0.0.0](https://help.aliyun.com/zh/mse/user-guide/ai-token-current-limiting?spm=higress-website.topbar.0.0.0)
<a name="vCKxn"></a>
## 应用架构
...
<a name="JsZEu"></a>
# AI 缓存
官方文档：[https://help.aliyun.com/zh/mse/user-guide/ai-cache?spm=higress-website.topbar.0.0.0](https://help.aliyun.com/zh/mse/user-guide/ai-cache?spm=higress-website.topbar.0.0.0)
<a name="TC3o5"></a>
## 应用架构
...
<a name="s8mOy"></a>
# AI RAG
官方文档：[https://help.aliyun.com/zh/mse/user-guide/ai-rag?spm=higress-website.topbar.0.0.0](https://help.aliyun.com/zh/mse/user-guide/ai-rag?spm=higress-website.topbar.0.0.0)
<a name="kXWcc"></a>
## 应用架构
...
- [prompt模板](https://help.aliyun.com/zh/mse/user-guide/ai-cue-template?spm=higress-website.topbar.0.0.0)
- [prompt装饰器](https://help.aliyun.com/zh/mse/user-guide/ai-cue-decorator?spm=higress-website.topbar.0.0.0)
...
<a name="V23pX"></a>
## AI 请求/响应智能转换
官方文档：[https://help.aliyun.com/zh/mse/user-guide/ai-request-response-intelligent-transformation?spm=higress-website.topbar.0.0.0](https://help.aliyun.com/zh/mse/user-guide/ai-request-response-intelligent-transformation?spm=higress-website.topbar.0.0.0)<br />请求响应转换插件支持对请求/响应进行智能转换，其工作流程如下图所示（示例中后端服务为httpbin）：<br />![](/img/1728551155021.png)<br />此插件可用于修改经过网关的请求/响应内容，例如将xml格式的响应修改为json格式。
<a name="rt3VL"></a>
## 插件配置
```yaml
response: 

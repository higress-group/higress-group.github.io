import{c as p,__tla as r}from"./astro-component.m4CCZO6J.js";import{r as c,m as v,u,__tla as y}from"./constant.AVt9Gloy.js";import{__tla as m}from"./astro/assets-service.BhtN0nM5.js";let s,d,a,t,o,l,n,g=Promise.all([(()=>{try{return r}catch{}})(),(()=>{try{return y}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let e;e=`<h2 id="feature-description">Feature Description</h2>
...
<p>REST-to-MCP tools support four different request parameter passing methods, which are <strong>mutually exclusive</strong> - only one can be used:</p>
<ol>
<li>
...
<li>
<p><strong>argsToJsonBody</strong>: When set to <code dir="auto">true</code>, tool parameters will be sent directly as a JSON object in the request body, and the <code dir="auto">Content-Type: application/json; charset=utf-8</code> header will be automatically added.</p>
...
<li>
<p><strong>argsToFormBody</strong>: When set to <code dir="auto">true</code>, tool parameters will be encoded as <code dir="auto">application/x-www-form-urlencoded</code> in the request body, and the appropriate Content-Type header will be automatically added.</p>
...
<div class="expressive-code"><figure class="frame not-content"><figcaption class="header"></figcaption><pre tabindex="0"><code></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code=""><div></div></button></div></figure></div>`,t={title:"MCP Server Plugin Configuration",description:"MCP Server Plugin Configuration Reference",date:"2025-04-03",category:"article",keywords:["higress","mcp","ai"],authors:"Chengtan"},a="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/ai/en/mcp-server.md",n=void 0,l=function(){return`# MCP Server Plugin Configuration

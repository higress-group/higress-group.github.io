import{c,__tla as o}from"./astro-component.DtWAgCJT.js";import{r,m as y,u as E,__tla as v}from"./constant.B58Rf8dY.js";import{__tla as u}from"./astro/assets-service.BMxLt3pn.js";let a,d,e,n,p,l,i,m=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return v}catch{}})(),(()=>{try{return u}catch{}})()]).then(async()=>{let s;s=`<h2 id="function-description">Function Description</h2>

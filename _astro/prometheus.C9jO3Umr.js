import{c as p,__tla as d}from"./astro-component.CkonuESJ.js";import{r as h,m as u,u as c,__tla as g}from"./constant.BTpLpjAm.js";import{__tla as m}from"./astro/assets-service.BSoMdJpH.js";let s,i,a,t,r,l,n,y=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let e;e=`<h2 id="use-the-higress-console-built-in-monitor-suite">Use the Higress Console Built-In Monitor Suite</h2>

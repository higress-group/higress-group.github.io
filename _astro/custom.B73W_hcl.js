import{c as p,__tla as c}from"./astro-component.m4CCZO6J.js";import{r as d,m as u,u as g,__tla as h}from"./constant.ByWDeEHI.js";import{__tla as m}from"./astro/assets-service.BhtN0nM5.js";let s,l,a,t,o,r,i,f=Promise.all([(()=>{try{return c}catch{}})(),(()=>{try{return h}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let e;e=`<h2 id="edit-the-wasm-file">Edit the Wasm file</h2>
<ol>
...
content-length: 0
\`\`\`
`},l=function(){return e},o=function(){return[{depth:2,slug:"edit-the-wasm-file",text:"Edit the Wasm file"},{depth:2,slug:"build-the-wasm-image",text:"Build the Wasm image"},{depth:3,slug:"step1-compile-wasm",text:"step1. Compile wasm"},{depth:3,slug:"step2-build-and-push-the-docker-image-of-the-plugin",text:"step2. Build and push the docker image of the plugin"},{depth:2,slug:"enable-wasm-plugin",text:"Enable Wasm plugin"},{depth:3,slug:"using-the-higress-console",text:"Using the Higress console"},{depth:3,slug:"using-crds",text:"Using CRDs"}]},s=p((y,v,b)=>{const{layout:E,...n}=t;return n.file=a,n.url=i,d`${u()}${g(e)}`})});export{s as Content,f as __tla,l as compiledContent,s as default,a as file,t as frontmatter,o as getHeadings,r as rawContent,i as url};

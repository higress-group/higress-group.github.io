import{c as n,r as l,m as s}from"./render-template.BxWVGK5g.js";import{u as d}from"./index.DVQprq0Y.js";import"./hooks.module.6Mr8QjZg.js";import"./preact.module.LHOPIhyX.js";import"./jsxRuntime.module.B-HT3-kV.js";import"./preload-helper.BiBI96sQ.js";const t=`<h2 id="higress-controller">Higress Controller</h2>
...
</ol>`,i={title:"Component Compilation Instructions",keywords:["higress","architecture"],description:"Higress Component Compilation Instructions.",custom_edit_url:"https://github.com/higress-group/higress-group.github.io/blob/main/i18n/zh-cn/docusaurus-plugin-content-docs/current/dev/architecture.md"},o="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/dev/architecture.md",a=void 0;function u(){return`
...
6. Follow the steps mentioned above in the "Quick Build" section to build an Higress Gateway image.`}function c(){return t}function h(){return[{depth:2,slug:"higress-controller",text:"Higress Controller"},{depth:2,slug:"higress-gateway",text:"Higress Gateway"},{depth:3,slug:"quick-build",text:"Quick Build"},{depth:3,slug:"full-build",text:"Full Build"}]}const r=n((g,p,m)=>{const{layout:b,...e}=i;return e.file=o,e.url=a,l`${s()}${d(t)}`});export{r as Content,c as compiledContent,r as default,o as file,i as frontmatter,h as getHeadings,u as rawContent,a as url};

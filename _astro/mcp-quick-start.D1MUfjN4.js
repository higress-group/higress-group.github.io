import{c,__tla as l}from"./astro-component.m4CCZO6J.js";import{r as d,m as u,u as v,__tla as g}from"./constant.ZI3O5-xu.js";import{__tla as h}from"./astro/assets-service.BhtN0nM5.js";let s,r,a,n,o,p,t,f=Promise.all([(()=>{try{return l}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let e;e=`<blockquote>
...
<h3 id="configure-nacos-mcp-registry">Configure Nacos MCP Registry</h3>
<blockquote>
<p><strong>Note\uFF1A</strong>
Nacos version >= 3.0\uFF0CHigress version >= 2.1.2</p>
</blockquote>
<p>Add Service Source<br>
<img src="https://img.alicdn.com/imgextra/i3/O1CN01Ksd48C1ru4g6ep9SU_!!6000000005690-2-tps-2422-198.png" alt="Add Service Source" referrerpolicy="no-referrer"></p>
<p>Create a Nacos 3.x service source and complete the relevant information.</p>
<p><img src="https://img.alicdn.com/imgextra/i3/O1CN01FGvSE71HVVGHTp1Cu_!!6000000000763-2-tps-588-1039.png" alt="Add Nacos 3.x Service Source" referrerpolicy="no-referrer"></p>
<p>Access the endpoint through the following rules:</p>
<ul>
<li>
<p>REST API to MCP type: <code dir="auto">http://{domain of associated MCP Server}/{MCP Server route path prefix}/{name of MCP Server in Nacos}</code>. For example, if the associated domain for the Nacos service source is <code dir="auto">mcp-registry.com</code>, the MCP server route path is <code dir="auto">/mcp</code>, and the name of the MCP service in Nacos is <code dir="auto">test</code>, then the final SSE protocol access path will be:
<code dir="auto">http://mcp-registry.com/mcp/test/sse</code></p>
</li>
<li>
<p>Directly proxy the native MCP type: <code dir="auto">http://{domain of associated MCP Server}/{MCP Server route path prefix}/{name of MCP Server in Nacos}/{SSE path of the original service}</code>. For example, if the associated domain for the Nacos service source is <code dir="auto">mcp-registry.com</code>, the MCP server route path is <code dir="auto">/mcp</code>, the name of the MCP service in Nacos is <code dir="auto">test</code>, and the original SSE path for the <code dir="auto">test</code> service is <code dir="auto">/mcp/sse</code>, then the final SSE protocol access path will be:
<code dir="auto">http://mcp-registry.com/mcp/test/mcp/sse</code></p>
</li>
</ul>

import{c as p,__tla as l}from"./astro-component.YcfuVWta.js";import{r as d,m as u,u as v,__tla as g}from"./constant.Cx6UCuye.js";import{__tla as h}from"./astro/assets-service.r1ocst81.js";let s,r,a,t,o,c,n,f=Promise.all([(()=>{try{return l}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let e;e=`<blockquote>
...
<blockquote>
<p><strong>Note:</strong>
The target service bound to the route is the one which will accept MCP tool requests.</p>
</blockquote>
...
</blockquote>`,t={title:"MCP Server Quick Start",description:"Higress AI Gateway provides unified MCP Server hosting capabilities, helping AI Agents quickly integrate with various data sources. Through MCP Server, AI Agents can easily access databases, REST APIs, and other external services without concerning themselves with specific connection details.",date:"2025-04-03",category:"article",keywords:["MCP Server"],authors:"Jingze"},a="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/ai/en/mcp-quick-start.md",n=void 0,c=function(){return`

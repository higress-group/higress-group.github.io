import{c,__tla as o}from"./astro-component.DIa0fJKh.js";import{r,m as v,u as y,__tla as E}from"./constant.DinD8ZYh.js";import{__tla as f}from"./astro/assets-service.tyfV9CK3.js";let e,p,a,n,l,d,i,u=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return E}catch{}})(),(()=>{try{return f}catch{}})()]).then(async()=>{let s;s=`<p>\u8FD9\u7AE0\u4E3B\u8981\u4ECB\u7ECD\u5982\u4F55\u4F7F\u7528 Higress \u63D2\u4EF6 Go SDK \u5B9E\u73B0 HTTP \u8C03\u7528\u3002</p>
<h2 id="1-envoy-\u96C6\u7FA4cluster\u540D\u79F0\u548C\u670D\u52A1\u53D1\u73B0\u6765\u6E90">1 Envoy \u96C6\u7FA4\uFF08Cluster\uFF09\u540D\u79F0\u548C\u670D\u52A1\u53D1\u73B0\u6765\u6E90</h2>
<p>Higress \u63D2\u4EF6\u7684 Go SDK \u5728\u8FDB\u884C HTTP \u548C Redis \u8C03\u7528\u65F6\uFF0C\u662F\u901A\u8FC7\u6307\u5B9A\u7684\u96C6\u7FA4\u540D\u79F0\u6765\u8BC6\u522B\u5E76\u8FDE\u63A5\u5230\u76F8\u5E94\u7684 Envoy \u96C6\u7FA4\u3002 \u6B64\u5916\uFF0CHigress \u5229\u7528 <a href="https://higress.cn/docs/latest/user/mcp-bridge/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">McpBridge</a> \u652F\u6301\u591A\u79CD\u670D\u52A1\u53D1\u73B0\u673A\u5236\uFF0C\u5305\u62EC\u9759\u6001\u914D\u7F6E\uFF08static\uFF09\u3001DNS\u3001Kubernetes \u670D\u52A1\u3001Eureka\u3001Consul\u3001Nacos\u3001\u4EE5\u53CA Zookeeper \u7B49\u3002
...
<p>FQDN \u5373\u5728\u670D\u52A1\u5217\u8868\u91CC\u770B\u5230\u7684\u670D\u52A1\u540D\u79F0\uFF0C\u5F62\u5982:\u201Cmy-cluster.static\u201D,\u201Cyour-cluster.dns\u201D,\u201Cfoo.default.svc.cluster.local\u201D</p>
<p>Host \u5B57\u6BB5\u7528\u4E8E\u53D1\u9001\u5B9E\u9645 HTTP \u8BF7\u6C42\u65F6\u7684\u7F3A\u7701\u914D\u7F6E\u57DF\u540D\uFF0C\u5982\u679C\u5728\u53D1\u9001\u65F6\u7684 URL \u91CC\u6307\u5B9A\u4E86\u57DF\u540D\uFF0C\u90A3\u4E48\u5C06\u4EE5\u6307\u5B9A\u7684\u4E3A\u51C6\u3002\u4E0B\u9762\u5176\u4ED6\u7684 cluster \u4E2D\u7684 Host \u5B57\u6BB5\u542B\u4E49\u4E5F\u662F\u4E00\u6837\u7684\u3002</p>
<h3 id="12-\u5F53\u524D\u8DEF\u7531\u7684\u670D\u52A1">1.2 \u5F53\u524D\u8DEF\u7531\u7684\u670D\u52A1</h3>
<div class="expressive-code"><figure class="frame not-content"><figcaption class="header"></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">type RouteCluster struct {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">Host string</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="type RouteCluster struct {\x7F  Host string\x7F}"><div></div></button></div></figure></div>
<p>\u96C6\u7FA4\u540D\u79F0\u662F\u76F4\u63A5\u901A\u8FC7 proxywasm.GetProperty([]string{\u201Ccluster_name\u201D}) \u83B7\u53D6\u7684\u5F53\u524D\u8DEF\u7531\u7684\u76EE\u6807\u96C6\u7FA4</p>
<h3 id="13-\u9759\u6001\u914D\u7F6Estatic">1.3 \u9759\u6001\u914D\u7F6E\uFF08static\uFF09</h3>
...
<h3 id="14-dns-\u914D\u7F6Edns">1.4 DNS \u914D\u7F6E\uFF08dns\uFF09</h3>
...
<h3 id="15-kubernetes-\u670D\u52A1kubernetes">1.5 Kubernetes \u670D\u52A1\uFF08kubernetes\uFF09</h3>
...
<h2 id="\u53C2\u8003">\u53C2\u8003</h2>
<ul>
<li>[1]<a href="https://higress.cn/docs/latest/user/mcp-bridge/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Mcp Bridge \u914D\u7F6E\u8BF4\u660E</a></li>
</ul>`,n={title:"HTTP \u8C03\u7528",keywords:["Higress"]},a="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/ebook/zh-cn/wasm17.md",i=void 0,d=function(){return`
# HTTP \u8C03\u7528
...
`},p=function(){return s},l=function(){return[{depth:2,slug:"1-envoy-\u96C6\u7FA4cluster\u540D\u79F0\u548C\u670D\u52A1\u53D1\u73B0\u6765\u6E90",text:"1 Envoy \u96C6\u7FA4\uFF08Cluster\uFF09\u540D\u79F0\u548C\u670D\u52A1\u53D1\u73B0\u6765\u6E90"},{depth:3,slug:"11-fqdn",text:"1.1 FQDN"},{depth:3,slug:"12-\u5F53\u524D\u8DEF\u7531\u7684\u670D\u52A1",text:"1.2 \u5F53\u524D\u8DEF\u7531\u7684\u670D\u52A1"},{depth:3,slug:"13-\u9759\u6001\u914D\u7F6Estatic",text:"1.3 \u9759\u6001\u914D\u7F6E\uFF08static\uFF09"},{depth:3,slug:"14-dns-\u914D\u7F6Edns",text:"1.4 DNS \u914D\u7F6E\uFF08dns\uFF09"},{depth:3,slug:"15-kubernetes-\u670D\u52A1kubernetes",text:"1.5 Kubernetes \u670D\u52A1\uFF08kubernetes\uFF09"},{depth:3,slug:"16-nacos",text:"1.6 Nacos"},{depth:3,slug:"17-consul",text:"1.7 Consul"},{depth:2,slug:"2-http-\u8C03\u7528",text:"2 HTTP \u8C03\u7528"},{depth:2,slug:"3-easy-jwt-\u63D2\u4EF6\u5F00\u53D1",text:"3 easy-jwt \u63D2\u4EF6\u5F00\u53D1"},{depth:3,slug:"31-\u63D2\u4EF6\u90E8\u5206\u6838\u5FC3\u4EE3\u7801",text:"3.1 \u63D2\u4EF6\u90E8\u5206\u6838\u5FC3\u4EE3\u7801"},{depth:3,slug:"32-\u90E8\u7F72\u548C\u9A8C\u8BC1",text:"3.2 \u90E8\u7F72\u548C\u9A8C\u8BC1"},{depth:2,slug:"4-ext-auth-\u63D2\u4EF6",text:"4 ext-auth \u63D2\u4EF6"},{depth:2,slug:"5-envoy-cluster-\u4E0D\u5B58\u5728\u95EE\u9898",text:"5 Envoy Cluster \u4E0D\u5B58\u5728\u95EE\u9898"},{depth:2,slug:"6-http-\u56DE\u8C03\u94FE\u95EE\u9898",text:"6 HTTP \u56DE\u8C03\u94FE\u95EE\u9898"},{depth:2,slug:"\u53C2\u8003",text:"\u53C2\u8003"}]},e=c((x,g,m)=>{const{layout:h,...t}=n;return t.file=a,t.url=i,r`${v()}${y(s)}`})});export{e as Content,u as __tla,p as compiledContent,e as default,a as file,n as frontmatter,l as getHeadings,d as rawContent,i as url};

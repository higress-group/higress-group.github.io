import{c as o,r as l,m as c}from"./render-template.DKq3LV42.js";import{u as r}from"./index.ZXqh_YvC.js";import"./hooks.module.6Mr8QjZg.js";import"./preact.module.LHOPIhyX.js";import"./jsxRuntime.module.B-HT3-kV.js";import"./preload-helper.BiBI96sQ.js";const s=`<h2 id="configure-through-the-higress-console">Configure through the Higress console</h2>
...
<p>// TODO\u2026</p>`,a={title:"Introduction to the use of Wasm plugins",keywords:["higress","wasm"],description:"Introduction to the Higress Wasm plugin"},i="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/plugins/intro.md",n=void 0;function d(){return`
...
// TODO...
`}function p(){return s}function u(){return[{depth:2,slug:"configure-through-the-higress-console",text:"Configure through the Higress console"},{depth:2,slug:"configuration-via-higress-wasmplugin-crd",text:"Configuration via Higress WasmPlugin CRD"},{depth:3,slug:"official-plugin-mirror-address",text:"Official plugin mirror address"},{depth:2,slug:"wasm-plugin-principle-introduction",text:"Wasm plugin principle introduction"},{depth:3,slug:"what-is-wasm",text:"What is Wasm"},{depth:3,slug:"plug-in-effective-process",text:"Plug-in effective process"},{depth:3,slug:"plug-in-execution-sequence-arrangement",text:"Plug-in execution sequence arrangement"},{depth:3,slug:"how-does-the-wasm-plugin-achieve-lossless-traffic-when-changing",text:"How does the Wasm plugin achieve lossless traffic when changing"}]}const t=o((g,h,f)=>{const{layout:m,...e}=a;return e.file=i,e.url=n,l`${c()}${r(s)}`});export{t as Content,p as compiledContent,t as default,i as file,a as frontmatter,u as getHeadings,d as rawContent,n as url};

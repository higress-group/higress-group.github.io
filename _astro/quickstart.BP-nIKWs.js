import{c as l,r as p,m as o}from"./render-template.DKq3LV42.js";import{u as d}from"./index.ZXqh_YvC.js";import"./hooks.module.6Mr8QjZg.js";import"./preact.module.LHOPIhyX.js";import"./jsxRuntime.module.B-HT3-kV.js";import"./preload-helper.BiBI96sQ.js";const e=`<h2 id="environment-1-use-in-k8s">Environment 1: Use in K8s</h2>
...
<p>when you install <code dir="auto">higress</code> in local environment, you should use <code dir="auto">--set global.kind=true</code>;
in the future, we will use <code dir="auto">--set global.local=true</code> for unambiguous.</p>
...
<p>Use <a href="https://higress.io/en-us/docs/ops/hgctl" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">hgctl</a> to open Higress Console.</p>
...
<p>Use the following command to check whether the test route works properly:</p>
<div class="expressive-code"><figure class="frame is-terminal not-content"><figcaption class="header"><span class="title"></span><span class="sr-only">Terminal window</span></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#99A0A6"># should output a JSON object containing request data</span></div></div><div class="ec-line"><div class="code"><span style="--0:#B392F0">curl</span><span style="--0:#E1E4E8"> </span><span style="--0:#9ECBFF">http://localhost/get?foo=bar</span><span style="--0:#E1E4E8"> </span><span style="--0:#79B8FF">-H</span><span style="--0:#E1E4E8"> </span><span style="--0:#9ECBFF">'host: foo.bar.com'</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="curl http://localhost/get?foo=bar -H &#x27;host: foo.bar.com&#x27;"><div></div></button></div></figure></div>`,a={title:"Quick Start",keywords:["Higress"],description:"Quick Start.",custom_edit_url:"https://github.com/higress-group/higress-group.github.io/blob/main/i18n/en-us/docusaurus-plugin-content-docs/current/user/quickstart.md",toc_max_heading_level:4},n="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/user/quickstart.md",t=void 0;function c(){return`
# Quick Start

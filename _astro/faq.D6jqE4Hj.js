import{c,__tla as h}from"./astro-component.CD2fzakh.js";import{r as d,m as p,u,__tla as g}from"./constant.DFdEcr0V.js";import{__tla as f}from"./astro/assets-service.Bk7KqR8o.js";let t,r,s,o,n,l,a,m=Promise.all([(()=>{try{return h}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return f}catch{}})()]).then(async()=>{let e;e=`<h1 id="faq">FAQ</h1>
...
<p><strong>A:</strong></p>
<p>Already supported, you can see it here: <a href="https://higress.io/en-us/docs/user/quickstart#environment-2-use-in-docker-compose-without-k8s" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">https://higress.io/en-us/docs/user/quickstart#environment-2-use-in-docker-compose-without-k8s</a></p>
<hr>
...
<p><strong>A:</strong></p>
<p>Supported, you can read this document: <a href="https://higress.io/zh-cn/docs/user/waf/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">https://higress.io/zh-cn/docs/user/waf/</a></p>
<hr>
...
<hr>`,o={title:"Higress FAQ",keywords:["Higress"],description:"Higress FAQ."},s="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/overview/faq.md",a=void 0,l=function(){return`
# FAQ
...
***********
`},r=function(){return e},n=function(){return[{depth:1,slug:"faq",text:"FAQ"}]},t=c((y,b,w)=>{const{layout:v,...i}=o;return i.file=s,i.url=a,d`${p()}${u(e)}`})});export{t as Content,m as __tla,r as compiledContent,t as default,s as file,o as frontmatter,n as getHeadings,l as rawContent,a as url};

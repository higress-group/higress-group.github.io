const e="latest/en/user/prometheus.md",t="docs",o="latest/en/user/prometheus",s=`
...
If you'd like to update the dashboard URL, you can click the "Reconfigure" button on the top left corner.`,a={title:"Ingress Traffic Monitoring with Prometheus",description:"Implement ingress traffic monitoring using Prometheus and Grafana with Higress",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["Higress","Prometheus","Monitoring","Metrics","Grafana"]},n={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/user/prometheus.md",rawData:void 0};export{n as _internal,s as body,t as collection,a as data,e as id,o as slug};

import{c as o,__tla as d}from"./astro-component.m4CCZO6J.js";import{r,m as v,u,__tla as E}from"./constant.B6p3iceL.js";import{__tla as y}from"./astro/assets-service.BhtN0nM5.js";let e,l,a,n,p,c,i,h=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return E}catch{}})(),(()=>{try{return y}catch{}})()]).then(async()=>{let s;s=`<p>Gateways play a crucial role in system architecture as they serve as the entry point connecting different networks, applications, and services. Web Application Firewall (WAF) is an essential security capability in the gateway domain, designed to identify and protect against malicious traffic patterns for websites or applications. By filtering and cleaning traffic, it ensures only normal, secure traffic reaches the server, preventing performance issues and security breaches caused by malicious intrusions, thereby safeguarding business and data security.</p>

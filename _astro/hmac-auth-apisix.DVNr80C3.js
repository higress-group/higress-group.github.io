const e="latest/en/plugins/authentication/hmac-auth-apisix.md",t="docs",a="latest/en/plugins/authentication/hmac-auth-apisix",s=`
## Feature Description
...
**Description**: When \`global_auth: true\`, all requests to the gateway must carry valid authentication information. Unauthenticated requests will be rejected directly.`,i={title:"APISIX HMAC Authentication",description:"Configuration Reference for the APISIX HMAC Authentication Plugin",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["higress","hmac auth","apisix"]},n={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/plugins/authentication/hmac-auth-apisix.md",rawData:void 0};export{n as _internal,s as body,t as collection,i as data,e as id,a as slug};

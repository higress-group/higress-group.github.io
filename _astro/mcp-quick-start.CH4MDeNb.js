import{c as l,__tla as c}from"./astro-component.m4CCZO6J.js";import{r as d,m as u,u as v,__tla as g}from"./constant.T4nJFeRa.js";import{__tla as E}from"./astro/assets-service.BhtN0nM5.js";let e,r,a,n,p,o,i,y=Promise.all([(()=>{try{return c}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return E}catch{}})()]).then(async()=>{let s;s=`<blockquote>
...
<div class="expressive-code"><figure class="frame not-content"><figcaption class="header"></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#85E89D">mcpServer</span><span style="--0:#E1E4E8">:</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">sse_path_suffix</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">/sse</span><span style="--0:#E1E4E8">  </span><span style="--0:#99A0A6"># Path suffix for SSE connections</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">enable</span><span style="--0:#E1E4E8">: </span><span style="--0:#79B8FF">true</span><span style="--0:#E1E4E8">          </span><span style="--0:#99A0A6"># Enable MCP Server</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">redis</span><span style="--0:#E1E4E8">:</span></div></div><div class="ec-line"><div class="code"><span class="indent">    </span><span style="--0:#85E89D">address</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">redis-stack-server.higress-system.svc.cluster.local:6379</span><span style="--0:#E1E4E8"> </span><span style="--0:#99A0A6"># Redis service address</span></div></div><div class="ec-line"><div class="code"><span class="indent">    </span><span style="--0:#85E89D">username</span><span style="--0:#E1E4E8">: </span><span style="--0:#99A0A6"># Redis username (optional)</span></div></div><div class="ec-line"><div class="code"><span class="indent">    </span><span style="--0:#85E89D">password</span><span style="--0:#E1E4E8">: </span><span style="--0:#99A0A6"># Redis password (optional)</span></div></div><div class="ec-line"><div class="code"><span class="indent">    </span><span style="--0:#85E89D">db</span><span style="--0:#E1E4E8">: </span><span style="--0:#99A0A6"># Redis database (optional)</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">match_list</span><span style="--0:#E1E4E8">:          </span><span style="--0:#99A0A6"># MCP Server routing rules</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#E1E4E8">    </span></span><span style="--0:#E1E4E8">- </span><span style="--0:#85E89D">match_rule_domain</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">"*"</span></div></div><div class="ec-line"><div class="code"><span class="indent">      </span><span style="--0:#85E89D">match_rule_path</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">/postgres</span></div></div><div class="ec-line"><div class="code"><span class="indent">      </span><span style="--0:#85E89D">match_rule_type</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">"prefix"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#E1E4E8">    </span></span><span style="--0:#E1E4E8">- </span><span style="--0:#85E89D">match_rule_domain</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">"*"</span></div></div><div class="ec-line"><div class="code"><span class="indent">      </span><span style="--0:#85E89D">match_rule_path</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">/user</span></div></div><div class="ec-line"><div class="code"><span class="indent">      </span><span style="--0:#85E89D">match_rule_type</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">"prefix"</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">serves</span><span style="--0:#E1E4E8">:</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="mcpServer:\x7F  sse_path_suffix: /sse  # Path suffix for SSE connections\x7F  enable: true          # Enable MCP Server\x7F  redis:\x7F    address: redis-stack-server.higress-system.svc.cluster.local:6379 # Redis service address\x7F    username: # Redis username (optional)\x7F    password: # Redis password (optional)\x7F    db: # Redis database (optional)\x7F  match_list:          # MCP Server routing rules\x7F    - match_rule_domain: &#x22;*&#x22;\x7F      match_rule_path: /postgres\x7F      match_rule_type: &#x22;prefix&#x22;\x7F    - match_rule_domain: &#x22;*&#x22;\x7F      match_rule_path: /user\x7F      match_rule_type: &#x22;prefix&#x22;\x7F  serves:"><div></div></button></div></figure></div>
<blockquote>
...
<p><img src="https://gw.alicdn.com/imgextra/i4/O1CN0175PEY11uVI4iiRKhM_!!6000000006042-0-tps-2496-566.jpg" alt="Add Service Source" referrerpolicy="no-referrer"></p>
...
<p><img src="https://gw.alicdn.com/imgextra/i2/O1CN01AvGOMg1ysswRGHvuM_!!6000000006635-0-tps-2528-624.jpg" alt="Configure Route" referrerpolicy="no-referrer"></p>
...
</blockquote>`,n={title:"MCP Server Quick Start",description:"MCP Server Quick Start Guide",date:"2025-04-03",category:"article",keywords:["MCP Server"],authors:"Jingze"},a="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/ai/en/mcp-quick-start.md",i=void 0,o=function(){return`

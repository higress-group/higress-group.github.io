import{c as d,__tla as p}from"./astro-component.DeDyO-JF.js";import{r as c,m as g,u as h,__tla as u}from"./constant.D3sBgQJr.js";import{__tla as m}from"./astro/assets-service.B3vdYoe2.js";let e,r,t,a,i,l,o,y=Promise.all([(()=>{try{return p}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let s;s=`<p><a href="https://helm.sh/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Helm</a> is a package manager for Kubernetes used in software management and deployment. You can use Helm to perform a quick install of Higress Gateway in your Kubernetes cluster.</p>
...
\`\`\`
`},r=function(){return s},i=function(){return[{depth:2,slug:"install-higress",text:"Install Higress"},{depth:3,slug:"helm-installation-command",text:"Helm Installation Command"},{depth:3,slug:"installation-parameters",text:"Installation Parameters"},{depth:2,slug:"support-istio-crd",text:"Support Istio CRD"}]},e=d((f,b,E)=>{const{layout:I,...n}=a;return n.file=t,n.url=o,c`${g()}${h(s)}`})});export{e as Content,y as __tla,r as compiledContent,e as default,t as file,a as frontmatter,i as getHeadings,l as rawContent,o as url};

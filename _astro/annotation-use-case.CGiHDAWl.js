const e="latest/en/user/annotation-use-case.md",s="docs",t="latest/en/user/annotation-use-case",a=`
      ...
      http:
        paths:
          - backend:
            ...
            pathType: Exact
\`\`\`
`,i={title:"Advanced Traffic Management with Ingress Annotations",description:"Using Ingress with Annotations to implement advanced traffic management in Higress.",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["Ingress Annotation"]},r={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/user/annotation-use-case.md",rawData:void 0};export{r as _internal,a as body,s as collection,i as data,e as id,t as slug};

import{c as n,r as o,m as l}from"./render-template.CJlwwtnB.js";import{u as p}from"./constant.CxavaNFL.js";import"./preload-helper.BiBI96sQ.js";const s=`<p>This is a guide for new contributor who wants to contribute to Higress.</p>
...
`}function c(){return s}function g(){return[{depth:3,slug:"subscribe-to-the-mailing-list",text:"Subscribe to the mailing list"},{depth:3,slug:"reporting-issue",text:"Reporting issue"},{depth:3,slug:"sending-pull-request",text:"Sending pull request"},{depth:3,slug:"code-convention",text:"Code convention"}]}const r=n((d,h,b)=>{const{layout:m,...e}=t;return e.file=a,e.url=i,o`${l()}${p(s)}`});export{r as Content,c as compiledContent,r as default,a as file,t as frontmatter,g as getHeadings,u as rawContent,i as url};

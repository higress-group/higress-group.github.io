import{c as p,__tla as d}from"./astro-component.YcfuVWta.js";import{r as c,m as g,u as h,__tla as u}from"./constant.Cx6UCuye.js";import{__tla as y}from"./astro/assets-service.r1ocst81.js";let s,n,t,a,i,l,o,m=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return y}catch{}})()]).then(async()=>{let e;e=`<p><a href="https://helm.sh/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Helm</a> is a package management system for automating the management and release of Kubernetes software. With Helm, you can quickly deploy and install Higress gateway on your Kubernetes cluster.</p>
...
<blockquote>
<p>Note: The highest version of Gateway API supported by Higress is 1.0.0.</p>
</blockquote>

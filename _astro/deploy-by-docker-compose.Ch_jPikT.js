import{c,__tla as d}from"./astro-component.YcfuVWta.js";import{r as p,m as g,u as h,__tla as u}from"./constant.9_4gXTQt.js";import{__tla as y}from"./astro/assets-service.r1ocst81.js";let t,r,s,o,i,l,n,m=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return y}catch{}})()]).then(async()=>{let e;e=`<p>Docker Compose is a tool for defining and running multi-container Docker applications. With it, we can use YAML files to deploy Higress gateway standalone without a K8s cluster.</p>
<blockquote>

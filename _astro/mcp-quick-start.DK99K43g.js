const e="en/mcp-quick-start.md",s="ai",t="en/mcp-quick-start",r=`
...
`,i={title:"MCP Server Quick Start",description:"Higress AI Gateway provides unified MCP Server hosting capabilities, helping AI Agents quickly integrate with various data sources. Through MCP Server, AI Agents can easily access databases, REST APIs, and other external services without concerning themselves with specific connection details.",keywords:["MCP Server"],date:"2025-04-03",category:"article"},a={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/ai/en/mcp-quick-start.md",rawData:void 0};export{a as _internal,r as body,s as collection,i as data,e as id,t as slug};

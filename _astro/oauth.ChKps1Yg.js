import{c as d,__tla as l}from"./astro-component.m4CCZO6J.js";import{r,m as p,u,__tla as h}from"./constant.vD8sQqEN.js";import{__tla as f}from"./astro/assets-service.BhtN0nM5.js";let t,x,i,a,o,c,n,g=Promise.all([(()=>{try{return l}catch{}})(),(()=>{try{return h}catch{}})(),(()=>{try{return f}catch{}})()]).then(async()=>{let e;e=`<h2 id="function-description">Function Description</h2>
...
<table><thead><tr><th>HTTP Status Code</th><th>Error Message</th><th>Explanation</th></tr></thead><tbody><tr><td>401</td><td>Invalid Jwt token</td><td>JWT not provided in request header, or JWT format is incorrect, or expired, etc.</td></tr><tr><td>403</td><td>Access Denied</td><td>No permission to access the current route.</td></tr></tbody></table>`,a={title:"OAuth2 Authentication",keywords:["higress","oauth2"],description:"OAuth2 authentication plugin configuration reference",githubHigressUrl:"https://github.com/alibaba/higress/tree/main/plugins/wasm-cpp/extensions/oauth"},i="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/plugins/authentication/oauth.md",n=void 0,c=function(){return`## Function Description

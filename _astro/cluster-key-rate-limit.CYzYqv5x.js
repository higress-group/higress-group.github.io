const e="latest/en/plugins/traffic/cluster-key-rate-limit.md",r="docs",i="latest/en/plugins/traffic/cluster-key-rate-limit",t=`## Function Description
...
show_limit_quota_header: true
\`\`\`
`,s={title:"Key-Based Cluster Rate Limiting",description:"Configuration reference for the Key-Based Cluster Rate Limiting plugin",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["higress","rate-limit"]},a={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/plugins/traffic/cluster-key-rate-limit.md",rawData:void 0};export{a as _internal,t as body,r as collection,s as data,e as id,i as slug};

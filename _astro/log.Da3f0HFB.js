import{c as p,__tla as o}from"./astro-component.m4CCZO6J.js";import{r as E,m as c,u as g,__tla as _}from"./constant.D4Mjy2rC.js";import{__tla as f}from"./astro/assets-service.BhtN0nM5.js";let e,d,t,a,i,r,n,y=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return _}catch{}})(),(()=>{try{return f}catch{}})()]).then(async()=>{let s;s=`<p>Custom log fields can be configured using the following command to edit the accessLogFormat field under the mesh field:</p>

import{c as p,__tla as r}from"./astro-component.m4CCZO6J.js";import{r as c,m as g,u,__tla as y}from"./constant.ZI3O5-xu.js";import{__tla as v}from"./astro/assets-service.BhtN0nM5.js";let s,o,t,a,d,l,n,h=Promise.all([(()=>{try{return r}catch{}})(),(()=>{try{return y}catch{}})(),(()=>{try{return v}catch{}})()]).then(async()=>{let e;e=`<blockquote>
<p><strong>Note</strong>:</p>
<p>TinyGo has specific version requirements. The current stable version combination that has been extensively validated is: TinyGo 0.29 + Go 1.20. You can refer to this official <a href="https://github.com/alibaba/higress/blob/main/plugins/wasm-go/Makefile" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Makefile</a></p>
<p>Go 1.24 now natively supports compiling WASM files. Documentation updates are in progress.</p>
</blockquote>
<h2 id="1-tool-preparation">1. Tool Preparation</h2>
<p>You need to install both Golang and TinyGo.</p>
<h3 id="1-golang">1. Golang</h3>
<p>(Requires version 1.18 or higher)<br>
...
<ol>
<li>Download the archive: <a href="https://go.dev/dl/go1.19.linux-amd64.tar.gz" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">https://go.dev/dl/go1.19.linux-amd64.tar.gz</a></li>
...
<p>(Requires version 0.28.1 or higher)<br>
Official installation guide: <a href="https://tinygo.org/getting-started/install/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">https://tinygo.org/getting-started/install/</a></p>
<h4 id="windows-1">Windows</h4>
<ol>
<li>Download the installer: <a href="https://github.com/tinygo-org/tinygo/releases/download/v0.28.1/tinygo0.28.1.windows-amd64.zip" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">https://github.com/tinygo-org/tinygo/releases/download/v0.28.1/tinygo0.28.1.windows-amd64.zip</a></li>
<li>Extract the archive to your desired directory</li>
<li>If you extracted to <code dir="auto">C:\\tinygo</code>, add <code dir="auto">C:\\tinygo\\bin</code> to your <code dir="auto">PATH</code> environment variable, for example by running:</li>
</ol>
...
<ol start="4">
<li>Open a command prompt and type <code dir="auto">tinygo version</code> to verify the installation</li>
</ol>
...
<ol start="2">
<li>If you extracted to <code dir="auto">/tmp</code>, add <code dir="auto">/tmp/tinygo/bin</code> to your <code dir="auto">PATH</code>:</li>
</ol>
...
<ol start="3">
<li>Open Terminal and type <code dir="auto">tinygo version</code> to verify the installation</li>
</ol>
<h4 id="linux-1">Linux</h4>
<p>For Ubuntu on amd64 architecture (other systems please refer to the official guide):</p>
<ol>
...
<h3 id="1-initialize-the-project-1">1. Initialize the Project</h3>
<ol>
...
\`\`\``},o=function(){return e},d=function(){return[{depth:2,slug:"1-tool-preparation",text:"1. Tool Preparation"},{depth:3,slug:"1-golang",text:"1. Golang"},{depth:4,slug:"windows",text:"Windows"},{depth:4,slug:"macos",text:"macOS"},{depth:4,slug:"linux",text:"Linux"},{depth:3,slug:"2-tinygo",text:"2. TinyGo"},{depth:4,slug:"windows-1",text:"Windows"},{depth:4,slug:"macos-1",text:"macOS"},{depth:4,slug:"linux-1",text:"Linux"},{depth:4,slug:"macos-2",text:"MacOS"},{depth:4,slug:"linux-2",text:"Linux"},{depth:3,slug:"2-tinygo-1",text:"2. TinyGo"},{depth:4,slug:"windows-2",text:"Windows"},{depth:4,slug:"macos-3",text:"MacOS"},{depth:4,slug:"linux-3",text:"Linux"},{depth:2,slug:"2-write-a-plugin",text:"2. Write a plugin"},{depth:3,slug:"1-initialize-the-project",text:"1. Initialize the project"},{depth:4,slug:"11-create-wasm-go-plugin-in-pluginswasm-go",text:"1.1 create wasm-go plugin in plugins/wasm-go"},{depth:4,slug:"12-create-a-new-project-yourself",text:"1.2 create a new project yourself"},{depth:2,slug:"2-writing-the-plugin",text:"2. Writing the Plugin"},{depth:3,slug:"1-initialize-the-project-1",text:"1. Initialize the Project"},{depth:3,slug:"2-writing-maingo",text:"2. Writing main.go"},{depth:4,slug:"http-processing-hooks",text:"HTTP Processing Hooks"},{depth:4,slug:"utility-methods",text:"Utility Methods"},{depth:4,slug:"http-processing-pointcuts",text:"HTTP Processing Pointcuts"},{depth:4,slug:"utility-functions",text:"Utility Functions"},{depth:3,slug:"3-compile-and-generate-wasm-file",text:"3. Compile and Generate WASM File"},{depth:4,slug:"31-building-wasm-go-plugin-image-with-scaffolding",text:"3.1 Building wasm-go plugin image with scaffolding"},{depth:4,slug:"32-compile-wasm-files-locally",text:"3.2 Compile wasm files locally"},{depth:2,slug:"3-local-debugging",text:"3. Local Debugging"},{depth:2,slug:"more-samples",text:"More Samples"},{depth:3,slug:"plugin-with-no-configuration",text:"Plugin with No Configuration"},{depth:3,slug:"send-requests-to-external-services-in-the-plugin",text:"Send Requests to External Services in the Plugin"}]},s=p((f,m,w)=>{const{layout:b,...i}=a;return i.file=t,i.url=n,c`${g()}${u(e)}`})});export{s as Content,h as __tla,o as compiledContent,s as default,t as file,a as frontmatter,d as getHeadings,l as rawContent,n as url};

import{c,__tla as o}from"./astro-component.YcfuVWta.js";import{r,m as v,u as E,__tla as y}from"./constant.Cx6UCuye.js";import{__tla as f}from"./astro/assets-service.r1ocst81.js";let e,t,n,a,l,d,i,x=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return y}catch{}})(),(()=>{try{return f}catch{}})()]).then(async()=>{let s;s=`<p><font style="color:rgb(33, 37, 41);">\u5C06\u5B58\u91CF OpenAPI \u6279\u91CF\u8F6C\u5316\u4E3A MCP Server\uFF0C\u8FD9\u662F Higress \u6700\u65B0\u5F00\u6E90\u7684\u80FD\u529B\uFF0C\u52A9\u529B\u5F00\u53D1\u8005\u4EEC\u9AD8\u6548\u6784\u5EFA MCP Server\u3002[1]</font></p>
...
<p><img src="/img/1770013034056.png" alt="" referrerpolicy="no-referrer"></p>
<h2 id="02-\u5C06\u5B58\u91CF-openapi-\u8F6C\u5316\u4E3A-mcp-server-\u7684\u5E38\u89C4\u505A\u6CD5"><font style="color:rgb(33, 37, 41);">02 \u5C06\u5B58\u91CF OpenAPI \u8F6C\u5316\u4E3A MCP Server \u7684\u5E38\u89C4\u505A\u6CD5</font></h2>
<p>MCP \u662F\u5141\u8BB8 LLM \u80FD\u591F\u901A\u8FC7\u6807\u51C6\u5316\u7684\u65B9\u5F0F\uFF0C\u8BBF\u95EE\u5916\u90E8\u8D44\u6E90\u3001\u6570\u636E\u548C\u670D\u52A1\u3002\u5C06\u5B58\u91CF OpenAPI \u8F6C\u5316\u4E3A MCP Server\uFF0C\u662F\u4E00\u79CD\u5229\u65E7\uFF0C\u662F\u5B9E\u73B0\u7ECF\u6D4E\u6548\u76CA\u7684\u9AD8\u6548\u8DEF\u5F84\uFF0C\u76EE\u7684\u662F\u4F7F\u81EA\u8EAB\u7684\u670D\u52A1\u80FD\u88AB\u5916\u90E8\u7684 AI \u5E94\u7528\u8FDB\u884C\u8C03\u7528\uFF0C\u4ECE\u800C\u63D0\u5347\u5B58\u91CF\u670D\u52A1\u7684\u4EF7\u503C\u3002\u4ECD\u7136\u4EE5\u9AD8\u5FB7\u5730\u56FE\u4E3A\u4F8B\uFF0C\u9AD8\u5FB7\u63D0\u4F9B\u5C06\u5B58\u91CF\u7684 OpenAPI \u670D\u52A1\uFF0C\u4F8B\u5982 IP \u5B9A\u4F4D\u3001\u5730\u7406\u7F16\u7801\u8F6C\u5316\u4E3A MCP Server\uFF0C\u5C31\u53EF\u4EE5\u8BA9\u5916\u90E8\u5E94\u7528\u8C03\u7528\u9AD8\u5FB7\u5730\u56FE\u7684\u80FD\u529B\uFF0C\u4ECE\u800C\u63D0\u5347\u670D\u52A1\u7684\u6D3B\u8DC3\u5EA6\u3002</p>
...
<h3 id="35-\u914D\u7F6E-mcp-server-\u63D2\u4EF6">3.5 \u914D\u7F6E MCP Server \u63D2\u4EF6</h3>
...
<img src="/img/1770013036638.png" alt="" referrerpolicy="no-referrer"></p>
<p>\u63D2\u4EF6\u914D\u7F6E\u793A\u4F8B\uFF1A</p>
...
<h3 id="36-\u8C03\u7528-mcp-server">3.6 \u8C03\u7528 MCP Server</h3>
...
<p>Cursor \u4E2D\u914D\u7F6E\u5B8C\u6210\uFF1A<br>
<img src="/img/1770013038892.png" alt="" referrerpolicy="no-referrer"></p>
...
`},t=function(){return s},l=function(){return[{depth:2,slug:"01-openapi-\u7684\u76F8\u5173\u6982\u5FF5",text:"01 OpenAPI \u7684\u76F8\u5173\u6982\u5FF5"},{depth:2,slug:"02-\u5C06\u5B58\u91CF-openapi-\u8F6C\u5316\u4E3A-mcp-server-\u7684\u5E38\u89C4\u505A\u6CD5",text:"02 \u5C06\u5B58\u91CF OpenAPI \u8F6C\u5316\u4E3A MCP Server \u7684\u5E38\u89C4\u505A\u6CD5"},{depth:2,slug:"03-\u6279\u91CF\u8F6C\u5316-openapi-\u81F3-mcp-server",text:"03 \u6279\u91CF\u8F6C\u5316 OpenAPI \u81F3 MCP Server"},{depth:3,slug:"31-\u5B89\u88C5",text:"3.1 \u5B89\u88C5"},{depth:3,slug:"32-\u4F7F\u7528",text:"3.2 \u4F7F\u7528"},{depth:3,slug:"33-\u793A\u4F8B",text:"3.3 \u793A\u4F8B"},{depth:3,slug:"34-\u529F\u80FD",text:"3.4 \u529F\u80FD"},{depth:3,slug:"35-\u914D\u7F6E-mcp-server-\u63D2\u4EF6",text:"3.5 \u914D\u7F6E MCP Server \u63D2\u4EF6"},{depth:3,slug:"36-\u8C03\u7528-mcp-server",text:"3.6 \u8C03\u7528 MCP Server"},{depth:2,slug:"04-\u5BF9-mcp-server-\u8FDB\u884C\u914D\u7F6E\u8C03\u4F18",text:"04 \u5BF9 MCP Server \u8FDB\u884C\u914D\u7F6E\u8C03\u4F18"},{depth:3,slug:"41-\u4E3A\u4EC0\u4E48\u9700\u8981\u8C03\u4F18mcp\u914D\u7F6E",text:"4.1 \u4E3A\u4EC0\u4E48\u9700\u8981\u8C03\u4F18MCP\u914D\u7F6E\uFF1F"},{depth:3,slug:"42-\u8C03\u4F18\u6848\u4F8B\u7535\u5546\u4EA7\u54C1\u641C\u7D22api",text:"4.2 \u8C03\u4F18\u6848\u4F8B\uFF1A\u7535\u5546\u4EA7\u54C1\u641C\u7D22API"},{depth:4,slug:"421-\u81EA\u52A8\u751F\u6210\u7684\u57FA\u7840\u914D\u7F6E",text:"4.2.1 \u81EA\u52A8\u751F\u6210\u7684\u57FA\u7840\u914D\u7F6E"},{depth:4,slug:"422-\u4EBA\u5DE5\u8C03\u4F18\u540E\u7684\u914D\u7F6E",text:"4.2.2 \u4EBA\u5DE5\u8C03\u4F18\u540E\u7684\u914D\u7F6E"},{depth:3,slug:"43-\u8C03\u4F18\u5982\u4F55\u6539\u5584llm\u7406\u89E3",text:"4.3 \u8C03\u4F18\u5982\u4F55\u6539\u5584LLM\u7406\u89E3"},{depth:4,slug:"431-\u8C03\u4F18\u524Dllm\u7684\u7406\u89E3\u95EE\u9898",text:"4.3.1 \u8C03\u4F18\u524DLLM\u7684\u7406\u89E3\u95EE\u9898"},{depth:4,slug:"432-\u8C03\u4F18\u540Ellm\u7684\u7406\u89E3\u6539\u8FDB",text:"4.3.2 \u8C03\u4F18\u540ELLM\u7684\u7406\u89E3\u6539\u8FDB"},{depth:3,slug:"44-\u8C03\u4F18\u7B56\u7565\u603B\u7ED3",text:"4.4 \u8C03\u4F18\u7B56\u7565\u603B\u7ED3"},{depth:2,slug:"05-\u7ED3\u8BED",text:"05 \u7ED3\u8BED"}]},e=c((m,g,u)=>{const{layout:F,...p}=a;return p.file=n,p.url=i,r`${v()}${E(s)}`})});export{e as Content,x as __tla,t as compiledContent,e as default,n as file,a as frontmatter,l as getHeadings,d as rawContent,i as url};

import{c as u,__tla as p}from"./astro-component.m4CCZO6J.js";import{r as l,m,u as g,__tla as d}from"./constant.DSXKRY5E.js";import{__tla as h}from"./astro/assets-service.BhtN0nM5.js";let t,i,o,s,a,c,r,y=Promise.all([(()=>{try{return p}catch{}})(),(()=>{try{return d}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let e;e=`<p>Aliyun ComputeNest is an open PaaS platform for service providers and users that provides software delivery, deployment, and operation process standardization capabilities. It supports the integration of software and resources for one-stop delivery, enabling truly out-of-the-box software usage.
...
</ul>`,s={title:"Rapid deployment through Aliyun ComputeNest",keywords:["deploy","docker compose","docker","ops","aliyun","computenest"],description:"How to Use Aliyun ComputeNest to Rapidly Deploy Higress.",custom_edit_url:"https://github.com/higress-group/higress-group.github.io/blob/main/src/content/docs/latest/en/ops/deploy-by-aliyun-computenest.md"},o="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/ops/deploy-by-aliyun-computenest.md",r=void 0,c=function(){return`

import{c as o,r,m as l}from"./render-template.CJlwwtnB.js";import{u as p}from"./constant.CxavaNFL.js";import"./preload-helper.BiBI96sQ.js";const n=`<p>If you would like to constribute source code for Higress, please check out the <a href="../../developers/guide_dev/" referrerpolicy="unsafe-url">Contribute Guide</a></p>
...
`}function c(){return n}function u(){return[]}const a=o((g,f,y)=>{const{layout:h,...e}=s;return e.file=i,e.url=t,r`${l()}${p(n)}`});export{a as Content,c as compiledContent,a as default,i as file,s as frontmatter,u as getHeadings,d as rawContent,t as url};

import{c,__tla as o}from"./astro-component.cI6d52vQ.js";import{r as v,m as r,u as y,__tla as E}from"./constant.DPqNCY_w.js";import{__tla as g}from"./astro/assets-service.Da9pL5MS.js";let e,l,a,n,t,d,p,x=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return E}catch{}})(),(()=>{try{return g}catch{}})()]).then(async()=>{let s;s=`<p>\u672C\u7AE0\u5F00\u59CB\u8FDB\u5165 Wasm \u63D2\u4EF6\u5F00\u53D1\u7BC7\uFF0C\u4E3B\u8981\u4ECB\u7ECD Wasm \u63D2\u4EF6\u914D\u7F6E\u3001Higress WasmPlugin CRD \u4EE5\u53CA\u5982\u4F55\u5F00\u53D1\u81EA\u5B9A\u4E49\u63D2\u4EF6\u3002</p>
...
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func main() {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">wrapper.SetCtx(</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u63D2\u4EF6\u540D\u79F0</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">"easy-logger",</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u89E3\u6790\u63D2\u4EF6\u914D\u7F6E</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ParseConfigBy(parseConfig),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessRequestHeadersBy(onHttpRequestHeaders),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessRequestBodyBy(onHttpRequestBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessResponseHeadersBy(onHttpResponseHeaders),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessResponseBodyBy(onHttpResponseBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u8BF7\u6C42\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">//wrapper.ProcessStreamingRequestBodyBy(onHttpStreamingRequestBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u54CD\u5E94\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">//wrapper.ProcessStreamingResponseBodyBy(onHttpStreamingResponseBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">)</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">// \u81EA\u5B9A\u4E49\u63D2\u4EF6\u914D\u7F6E</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">type LoggerConfig struct {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u662F\u5426\u6253\u5370\u8BF7\u6C42</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">request bool</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u662F\u5426\u6253\u5370\u54CD\u5E94</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">response bool</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u6253\u5370\u54CD\u5E94\u72B6\u6001\u7801\uFF0C* \u8868\u793A\u6253\u5370\u6240\u6709\u72B6\u6001\u54CD\u5E94\uFF0C500,502,503 \u8868\u793A\u6253\u5370 HTTP 500\u3001502\u3001503 \u72B6\u6001\u54CD\u5E94\uFF0C\u9ED8\u8BA4\u662F *</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">responseStatusCodes string</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func parseConfig(json gjson.Result, config *LoggerConfig, log wrapper.Log) error {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("parseConfig()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">config.request = json.Get("request").Bool()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">config.response = json.Get("response").Bool()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">config.responseStatusCodes = json.Get("responseStatusCodes").String()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if config.responseStatusCodes == "" {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">config.responseStatusCodes = "*"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("parse config:%v", config)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return nil</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpRequestHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpRequestHeaders()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpRequestBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpRequestBody()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpResponseBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpResponseBody()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpResponseHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpResponseHeaders()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="package main\x7F\x7Fimport (\x7F  &#x22;github.com/alibaba/higress/plugins/wasm-go/pkg/wrapper&#x22;\x7F  &#x22;github.com/higress-group/proxy-wasm-go-sdk/proxywasm/types&#x22;\x7F  &#x22;github.com/tidwall/gjson&#x22;\x7F)\x7F\x7Ffunc main() {\x7F  wrapper.SetCtx(\x7F    // \u63D2\u4EF6\u540D\u79F0\x7F    &#x22;easy-logger&#x22;,\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u89E3\u6790\u63D2\u4EF6\u914D\u7F6E\x7F    wrapper.ParseConfigBy(parseConfig),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u5934\x7F    wrapper.ProcessRequestHeadersBy(onHttpRequestHeaders),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u4F53\x7F    wrapper.ProcessRequestBodyBy(onHttpRequestBody),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u5934\x7F    wrapper.ProcessResponseHeadersBy(onHttpResponseHeaders),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u4F53\x7F    wrapper.ProcessResponseBodyBy(onHttpResponseBody),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u8BF7\u6C42\u4F53\x7F    //wrapper.ProcessStreamingRequestBodyBy(onHttpStreamingRequestBody),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u54CD\u5E94\u4F53\x7F    //wrapper.ProcessStreamingResponseBodyBy(onHttpStreamingResponseBody),\x7F  )\x7F}\x7F\x7F// \u81EA\u5B9A\u4E49\u63D2\u4EF6\u914D\u7F6E\x7Ftype LoggerConfig struct {\x7F  // \u662F\u5426\u6253\u5370\u8BF7\u6C42\x7F  request bool\x7F  // \u662F\u5426\u6253\u5370\u54CD\u5E94\x7F  response bool\x7F  // \u6253\u5370\u54CD\u5E94\u72B6\u6001\u7801\uFF0C* \u8868\u793A\u6253\u5370\u6240\u6709\u72B6\u6001\u54CD\u5E94\uFF0C500,502,503 \u8868\u793A\u6253\u5370 HTTP 500\u3001502\u3001503 \u72B6\u6001\u54CD\u5E94\uFF0C\u9ED8\u8BA4\u662F *\x7F  responseStatusCodes string\x7F}\x7F\x7Ffunc parseConfig(json gjson.Result, config *LoggerConfig, log wrapper.Log) error {\x7F  log.Debugf(&#x22;parseConfig()&#x22;)\x7F  config.request = json.Get(&#x22;request&#x22;).Bool()\x7F  config.response = json.Get(&#x22;response&#x22;).Bool()\x7F  config.responseStatusCodes = json.Get(&#x22;responseStatusCodes&#x22;).String()\x7F  if config.responseStatusCodes == &#x22;&#x22; {\x7F    config.responseStatusCodes = &#x22;*&#x22;\x7F  }\x7F  log.Debugf(&#x22;parse config:%v&#x22;, config)\x7F  return nil\x7F}\x7F\x7Ffunc onHttpRequestHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpRequestHeaders()&#x22;)\x7F  return types.ActionContinue\x7F}\x7F\x7Ffunc onHttpRequestBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpRequestBody()&#x22;)\x7F  return types.ActionContinue\x7F}\x7F\x7Ffunc onHttpResponseBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpResponseBody()&#x22;)\x7F  return types.ActionContinue\x7F}\x7F\x7Ffunc onHttpResponseHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpResponseHeaders()&#x22;)\x7F  return types.ActionContinue\x7F}"><div></div></button></div></figure></div>
...
<div class="expressive-code"><figure class="frame not-content"><figcaption class="header"></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">package main</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">import (</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">"fmt"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">"strings"</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">"github.com/alibaba/higress/plugins/wasm-go/pkg/wrapper"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">"github.com/google/uuid"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">"github.com/higress-group/proxy-wasm-go-sdk/proxywasm"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">"github.com/higress-group/proxy-wasm-go-sdk/proxywasm/types"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">"github.com/tidwall/gjson"</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">)</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func main() {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">wrapper.SetCtx(</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u63D2\u4EF6\u540D\u79F0</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">"easy-logger",</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u89E3\u6790\u63D2\u4EF6\u914D\u7F6E</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ParseConfigBy(parseConfig),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessRequestHeadersBy(onHttpRequestHeaders),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessRequestBodyBy(onHttpRequestBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessResponseHeadersBy(onHttpResponseHeaders),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">wrapper.ProcessResponseBodyBy(onHttpResponseBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u8BF7\u6C42\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">//wrapper.ProcessStreamingRequestBodyBy(onHttpStreamingRequestBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">// \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u54CD\u5E94\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">//wrapper.ProcessStreamingResponseBodyBy(onHttpStreamingResponseBody),</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">)</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">// \u81EA\u5B9A\u4E49\u63D2\u4EF6\u914D\u7F6E</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">type LoggerConfig struct {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u662F\u5426\u6253\u5370\u8BF7\u6C42</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">request bool</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u662F\u5426\u6253\u5370\u54CD\u5E94</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">response bool</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u6253\u5370\u54CD\u5E94\u72B6\u6001\u7801\uFF0C* \u8868\u793A\u6253\u5370\u6240\u6709\u72B6\u6001\u54CD\u5E94\uFF0C500,502,503 \u8868\u793A\u6253\u5370 HTTP 500\u3001502\u3001503 \u72B6\u6001\u54CD\u5E94\uFF0C\u9ED8\u8BA4\u662F *</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">responseStatusCodes string</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func parseConfig(json gjson.Result, config *LoggerConfig, log wrapper.Log) error {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("parseConfig()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">config.request = json.Get("request").Bool()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">config.response = json.Get("response").Bool()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">config.responseStatusCodes = json.Get("responseStatusCodes").String()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if config.responseStatusCodes == "" {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">config.responseStatusCodes = "*"</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("parse config:%+v", config)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return nil</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpRequestHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpRequestHeaders()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">requestId := uuid.New().String()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">ctx.SetContext("requestId", requestId)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if !config.request {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u83B7\u53D6\u5E76\u6253\u5370\u8BF7\u6C42\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">headers, _ := proxywasm.GetHttpRequestHeaders()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">var build strings.Builder</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">build.WriteString("\\n===========request headers===============\\n")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("requestId:%s\\n", requestId))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">for _, values := range headers {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("%s:%s\\n", values[0], values[1]))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Infof(build.String())</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u7EE7\u7EED\u5904\u7406\u8BF7\u6C42</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpRequestBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpRequestBody()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u6253\u5370\u8BF7\u6C42\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if config.request {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">var build strings.Builder</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString("\\n===========request body===============\\n")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">requestId := ctx.GetContext("requestId").(string)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("requestId:%s\\n", requestId))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("body:%s\\n", string(body)))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">log.Infof(build.String())</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpResponseHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpResponseHeaders()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u6DFB\u52A0\u81EA\u5B9A\u4E49\u54CD\u5E94\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">proxywasm.AddHttpResponseHeader("x-easy-logger", "1.0.0")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if !config.response {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u83B7\u53D6\u54CD\u5E94\u72B6\u6001\u7801</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">statusCode, _ := proxywasm.GetHttpResponseHeader(":status")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">logResponseBody := false</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u6839\u636E\u54CD\u5E94\u72B6\u6001\u7801\u51B3\u5B9A\u662F\u5426\u6253\u5370\u54CD\u5E94\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if config.responseStatusCodes == "*" || strings.Contains(config.responseStatusCodes, statusCode) {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">logResponseBody = true</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u5C06\u662F\u5426\u8BB0\u5F55\u54CD\u5E94\u4F53\u7684\u4FE1\u606F\u5B58\u50A8\u5728\u4E0A\u4E0B\u6587\u4E2D\uFF0C\u5728 onHttpResponseBody \u9636\u6BB5\u83B7\u53D6\u4E0A\u4E0B\u6587\u5224\u65AD\u662F\u5426\u6253\u5370\u54CD\u5E94\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">ctx.SetContext("logResponseBody", logResponseBody)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u83B7\u53D6\u54CD\u5E94\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">headers, _ := proxywasm.GetHttpResponseHeaders()</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u6253\u5370\u54CD\u5E94\u5934</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">var build strings.Builder</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">build.WriteString("\\n===========response headers===============\\n")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">requestId := ctx.GetContext("requestId").(string)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("requestId:%s\\n", requestId))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">for _, values := range headers {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("%s:%s\\n", values[0], values[1]))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Infof(build.String())</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code">
</div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">func onHttpResponseBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">log.Debugf("onHttpResponseBody()")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u83B7\u53D6\u5728 onHttpRequestHeaders \u9636\u6BB5\u8BBE\u7F6E\u7684\u4E0A\u4E0B\u6587</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">logResponseBody, ok := ctx.GetContext("logResponseBody").(bool)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if !ok {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">// \u6253\u5370\u54CD\u5E94\u4F53</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">if logResponseBody {</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">var build strings.Builder</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString("\\n===========response body===============\\n")</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">requestId := ctx.GetContext("requestId").(string)</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("requestId:%s\\n", requestId))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">build.WriteString(fmt.Sprintf("body:%s\\n", string(body)))</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">    </span></span><span style="--0:#e1e4e8">log.Infof(build.String())</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">}</span></div></div><div class="ec-line"><div class="code"><span class="indent"><span style="--0:#e1e4e8">  </span></span><span style="--0:#e1e4e8">return types.ActionContinue</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">}</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="package main\x7F\x7Fimport (\x7F  &#x22;fmt&#x22;\x7F  &#x22;strings&#x22;\x7F\x7F  &#x22;github.com/alibaba/higress/plugins/wasm-go/pkg/wrapper&#x22;\x7F  &#x22;github.com/google/uuid&#x22;\x7F  &#x22;github.com/higress-group/proxy-wasm-go-sdk/proxywasm&#x22;\x7F  &#x22;github.com/higress-group/proxy-wasm-go-sdk/proxywasm/types&#x22;\x7F  &#x22;github.com/tidwall/gjson&#x22;\x7F)\x7F\x7Ffunc main() {\x7F  wrapper.SetCtx(\x7F    // \u63D2\u4EF6\u540D\u79F0\x7F    &#x22;easy-logger&#x22;,\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u89E3\u6790\u63D2\u4EF6\u914D\u7F6E\x7F    wrapper.ParseConfigBy(parseConfig),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u5934\x7F    wrapper.ProcessRequestHeadersBy(onHttpRequestHeaders),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u8BF7\u6C42\u4F53\x7F    wrapper.ProcessRequestBodyBy(onHttpRequestBody),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u5934\x7F    wrapper.ProcessResponseHeadersBy(onHttpResponseHeaders),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u54CD\u5E94\u4F53\x7F    wrapper.ProcessResponseBodyBy(onHttpResponseBody),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u8BF7\u6C42\u4F53\x7F    //wrapper.ProcessStreamingRequestBodyBy(onHttpStreamingRequestBody),\x7F    // \u8BBE\u7F6E\u81EA\u5B9A\u4E49\u51FD\u6570\u5904\u7406\u6D41\u5F0F\u54CD\u5E94\u4F53\x7F    //wrapper.ProcessStreamingResponseBodyBy(onHttpStreamingResponseBody),\x7F  )\x7F}\x7F\x7F// \u81EA\u5B9A\u4E49\u63D2\u4EF6\u914D\u7F6E\x7Ftype LoggerConfig struct {\x7F  // \u662F\u5426\u6253\u5370\u8BF7\u6C42\x7F  request bool\x7F  // \u662F\u5426\u6253\u5370\u54CD\u5E94\x7F  response bool\x7F  // \u6253\u5370\u54CD\u5E94\u72B6\u6001\u7801\uFF0C* \u8868\u793A\u6253\u5370\u6240\u6709\u72B6\u6001\u54CD\u5E94\uFF0C500,502,503 \u8868\u793A\u6253\u5370 HTTP 500\u3001502\u3001503 \u72B6\u6001\u54CD\u5E94\uFF0C\u9ED8\u8BA4\u662F *\x7F  responseStatusCodes string\x7F}\x7F\x7Ffunc parseConfig(json gjson.Result, config *LoggerConfig, log wrapper.Log) error {\x7F  log.Debugf(&#x22;parseConfig()&#x22;)\x7F  config.request = json.Get(&#x22;request&#x22;).Bool()\x7F  config.response = json.Get(&#x22;response&#x22;).Bool()\x7F  config.responseStatusCodes = json.Get(&#x22;responseStatusCodes&#x22;).String()\x7F  if config.responseStatusCodes == &#x22;&#x22; {\x7F    config.responseStatusCodes = &#x22;*&#x22;\x7F  }\x7F  log.Debugf(&#x22;parse config:%+v&#x22;, config)\x7F  return nil\x7F}\x7F\x7Ffunc onHttpRequestHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpRequestHeaders()&#x22;)\x7F  requestId := uuid.New().String()\x7F  ctx.SetContext(&#x22;requestId&#x22;, requestId)\x7F  if !config.request {\x7F    return types.ActionContinue\x7F  }\x7F  // \u83B7\u53D6\u5E76\u6253\u5370\u8BF7\u6C42\u5934\x7F  headers, _ := proxywasm.GetHttpRequestHeaders()\x7F  var build strings.Builder\x7F  build.WriteString(&#x22;\\n===========request headers===============\\n&#x22;)\x7F  build.WriteString(fmt.Sprintf(&#x22;requestId:%s\\n&#x22;, requestId))\x7F  for _, values := range headers {\x7F    build.WriteString(fmt.Sprintf(&#x22;%s:%s\\n&#x22;, values[0], values[1]))\x7F  }\x7F  log.Infof(build.String())\x7F  // \u7EE7\u7EED\u5904\u7406\u8BF7\u6C42\x7F  return types.ActionContinue\x7F}\x7F\x7Ffunc onHttpRequestBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpRequestBody()&#x22;)\x7F  // \u6253\u5370\u8BF7\u6C42\u4F53\x7F  if config.request {\x7F    var build strings.Builder\x7F    build.WriteString(&#x22;\\n===========request body===============\\n&#x22;)\x7F    requestId := ctx.GetContext(&#x22;requestId&#x22;).(string)\x7F    build.WriteString(fmt.Sprintf(&#x22;requestId:%s\\n&#x22;, requestId))\x7F    build.WriteString(fmt.Sprintf(&#x22;body:%s\\n&#x22;, string(body)))\x7F    log.Infof(build.String())\x7F  }\x7F  return types.ActionContinue\x7F}\x7F\x7Ffunc onHttpResponseHeaders(ctx wrapper.HttpContext, config LoggerConfig, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpResponseHeaders()&#x22;)\x7F  // \u6DFB\u52A0\u81EA\u5B9A\u4E49\u54CD\u5E94\u5934\x7F  proxywasm.AddHttpResponseHeader(&#x22;x-easy-logger&#x22;, &#x22;1.0.0&#x22;)\x7F  if !config.response {\x7F    return types.ActionContinue\x7F  }\x7F  // \u83B7\u53D6\u54CD\u5E94\u72B6\u6001\u7801\x7F  statusCode, _ := proxywasm.GetHttpResponseHeader(&#x22;:status&#x22;)\x7F  logResponseBody := false\x7F  // \u6839\u636E\u54CD\u5E94\u72B6\u6001\u7801\u51B3\u5B9A\u662F\u5426\u6253\u5370\u54CD\u5E94\u4F53\x7F  if config.responseStatusCodes == &#x22;*&#x22; || strings.Contains(config.responseStatusCodes, statusCode) {\x7F    logResponseBody = true\x7F  }\x7F  // \u5C06\u662F\u5426\u8BB0\u5F55\u54CD\u5E94\u4F53\u7684\u4FE1\u606F\u5B58\u50A8\u5728\u4E0A\u4E0B\u6587\u4E2D\uFF0C\u5728 onHttpResponseBody \u9636\u6BB5\u83B7\u53D6\u4E0A\u4E0B\u6587\u5224\u65AD\u662F\u5426\u6253\u5370\u54CD\u5E94\u4F53\x7F  ctx.SetContext(&#x22;logResponseBody&#x22;, logResponseBody)\x7F  // \u83B7\u53D6\u54CD\u5E94\u5934\x7F  headers, _ := proxywasm.GetHttpResponseHeaders()\x7F  // \u6253\u5370\u54CD\u5E94\u5934\x7F  var build strings.Builder\x7F  build.WriteString(&#x22;\\n===========response headers===============\\n&#x22;)\x7F  requestId := ctx.GetContext(&#x22;requestId&#x22;).(string)\x7F  build.WriteString(fmt.Sprintf(&#x22;requestId:%s\\n&#x22;, requestId))\x7F  for _, values := range headers {\x7F    build.WriteString(fmt.Sprintf(&#x22;%s:%s\\n&#x22;, values[0], values[1]))\x7F  }\x7F  log.Infof(build.String())\x7F  return types.ActionContinue\x7F}\x7F\x7Ffunc onHttpResponseBody(ctx wrapper.HttpContext, config LoggerConfig, body []byte, log wrapper.Log) types.Action {\x7F  log.Debugf(&#x22;onHttpResponseBody()&#x22;)\x7F  // \u83B7\u53D6\u5728 onHttpRequestHeaders \u9636\u6BB5\u8BBE\u7F6E\u7684\u4E0A\u4E0B\u6587\x7F  logResponseBody, ok := ctx.GetContext(&#x22;logResponseBody&#x22;).(bool)\x7F  if !ok {\x7F    return types.ActionContinue\x7F  }\x7F  // \u6253\u5370\u54CD\u5E94\u4F53\x7F  if logResponseBody {\x7F    var build strings.Builder\x7F    build.WriteString(&#x22;\\n===========response body===============\\n&#x22;)\x7F    requestId := ctx.GetContext(&#x22;requestId&#x22;).(string)\x7F    build.WriteString(fmt.Sprintf(&#x22;requestId:%s\\n&#x22;, requestId))\x7F    build.WriteString(fmt.Sprintf(&#x22;body:%s\\n&#x22;, string(body)))\x7F    log.Infof(build.String())\x7F  }\x7F  return types.ActionContinue\x7F}"><div></div></button></div></figure></div>
...
`},l=function(){return s},t=function(){return[{depth:2,slug:"1-\u6D4B\u8BD5\u73AF\u5883\u51C6\u5907",text:"1 \u6D4B\u8BD5\u73AF\u5883\u51C6\u5907"},{depth:2,slug:"2-wasm-\u63D2\u4EF6\u914D\u7F6E",text:"2 Wasm \u63D2\u4EF6\u914D\u7F6E"},{depth:2,slug:"3-higress-wasmplugin-crd",text:"3 Higress WasmPlugin CRD"},{depth:2,slug:"4-\u81EA\u5B9A\u4E49\u63D2\u4EF6\u5F00\u53D1",text:"4 \u81EA\u5B9A\u4E49\u63D2\u4EF6\u5F00\u53D1"},{depth:3,slug:"41-\u73AF\u5883\u51C6\u5907",text:"4.1 \u73AF\u5883\u51C6\u5907"},{depth:3,slug:"42-\u5F00\u53D1\u548C\u6D4B\u8BD5",text:"4.2 \u5F00\u53D1\u548C\u6D4B\u8BD5"},{depth:4,slug:"421-\u521D\u59CB\u5316\u5DE5\u7A0B\u76EE\u5F55",text:"4.2.1 \u521D\u59CB\u5316\u5DE5\u7A0B\u76EE\u5F55"},{depth:4,slug:"422-\u7F16\u5199-maingo-\u6587\u4EF6",text:"4.2.2 \u7F16\u5199 main.go \u6587\u4EF6"},{depth:4,slug:"433-\u672C\u5730\u6D4B\u8BD5",text:"4.3.3 \u672C\u5730\u6D4B\u8BD5"},{depth:3,slug:"43-\u5B8C\u5584\u63D2\u4EF6\u529F\u80FD",text:"4.3 \u5B8C\u5584\u63D2\u4EF6\u529F\u80FD"},{depth:3,slug:"44-\u90E8\u7F72\u63D2\u4EF6\u548C\u9A8C\u8BC1",text:"4.4 \u90E8\u7F72\u63D2\u4EF6\u548C\u9A8C\u8BC1"}]},e=c((f,u,F)=>{const{layout:m,...i}=n;return i.file=a,i.url=p,v`${r()}${y(s)}`})});export{e as Content,x as __tla,l as compiledContent,e as default,a as file,n as frontmatter,t as getHeadings,d as rawContent,p as url};

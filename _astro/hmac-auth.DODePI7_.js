import{c as o,r,m as d}from"./render-template.DKq3LV42.js";import{u as c}from"./index.ZXqh_YvC.js";import"./hooks.module.6Mr8QjZg.js";import"./preact.module.LHOPIhyX.js";import"./jsxRuntime.module.B-HT3-kV.js";import"./preload-helper.BiBI96sQ.js";const t=`<h2 id="function-description">Function Description</h2>
...
`}function p(){return t}function h(){return[{depth:2,slug:"function-description",text:"Function Description"},{depth:2,slug:"configuration-fields",text:"Configuration Fields"},{depth:2,slug:"configuration-example",text:"Configuration Example"},{depth:3,slug:"enabling-for-specific-routes-or-domains",text:"Enabling for specific routes or domains"},{depth:3,slug:"enable-at-the-gateway-instance-level",text:"Enable at the Gateway Instance Level"},{depth:2,slug:"description-of-signing-mechanism",text:"Description of Signing Mechanism"},{depth:3,slug:"configuration-preparation",text:"Configuration Preparation"},{depth:3,slug:"client-signature-generation-method",text:"Client Signature Generation Method"},{depth:4,slug:"overview-of-the-process",text:"Overview of the Process"},{depth:4,slug:"process-for-extracting-signing-string",text:"Process for Extracting Signing String"},{depth:4,slug:"example-of-extracting-signing-string",text:"Example of Extracting Signing String"},{depth:4,slug:"signature-calculation-process",text:"Signature Calculation Process"},{depth:4,slug:"the-process-of-adding-a-signature",text:"The Process of Adding a Signature"},{depth:3,slug:"server-side-signature-verification-method",text:"Server-side Signature Verification Method"},{depth:4,slug:"overview-of-the-process-1",text:"Overview of the Process"},{depth:3,slug:"troubleshooting-signature-errors",text:"Troubleshooting Signature Errors"},{depth:2,slug:"related-error-codes",text:"Related Error Codes"}]}const n=o((u,g,f)=>{const{layout:m,...e}=a;return e.file=s,e.url=i,r`${d()}${c(t)}`});export{n as Content,p as compiledContent,n as default,s as file,a as frontmatter,h as getHeadings,l as rawContent,i as url};

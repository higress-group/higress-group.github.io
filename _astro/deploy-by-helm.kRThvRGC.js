import{c as d,__tla as p}from"./astro-component.DeDyO-JF.js";import{r as c,m as g,u as h,__tla as u}from"./constant.BXVyT3gx.js";import{__tla as m}from"./astro/assets-service.B3vdYoe2.js";let e,r,t,a,i,l,o,y=Promise.all([(()=>{try{return p}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let s;s=`<p><a href="https://helm.sh/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Helm</a> is a package manager for Kubernetes used in software management and deployment. You can use Helm to perform a quick install of Higress Gateway in your Kubernetes cluster.</p>

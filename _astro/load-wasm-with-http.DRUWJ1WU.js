import{c as l,__tla as p}from"./astro-component.m4CCZO6J.js";import{r as d,m as h,u,__tla as m}from"./constant.C798a0v1.js";import{__tla as g}from"./astro/assets-service.BhtN0nM5.js";let e,a,o,i,n,c,s,f=Promise.all([(()=>{try{return p}catch{}})(),(()=>{try{return m}catch{}})(),(()=>{try{return g}catch{}})()]).then(async()=>{let t;t=`<h2 id="file-requirement">File Requirement</h2>
...
\`\`\`
`},a=function(){return t},n=function(){return[{depth:2,slug:"file-requirement",text:"File Requirement"},{depth:2,slug:"http-protocol",text:"HTTP Protocol"},{depth:2,slug:"https-protocol",text:"HTTPS Protocol"}]},e=l((T,w,y)=>{const{layout:_,...r}=i;return r.file=o,r.url=s,d`${h()}${u(t)}`})});export{e as Content,f as __tla,a as compiledContent,e as default,o as file,i as frontmatter,n as getHeadings,c as rawContent,s as url};

const e="latest/en/user/spring-cloud.md",s="docs",i="latest/en/user/spring-cloud",r=`
...
Note that if spring.cloud.zookeeper.discovery.root contains underscores, they need to be replaced with hyphens, because the overall target service format must comply with DNS domain name standards.`,o={title:"Implementing SpringCloud Service Discovery and Routing",description:"Implementing SpringCloud Service Discovery and Routing.",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["SpringCloud","discovery"]},t={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/user/spring-cloud.md",rawData:void 0};export{t as _internal,r as body,s as collection,o as data,e as id,i as slug};

import{c,__tla as d}from"./astro-component.m4CCZO6J.js";import{r as p,m as g,u as h,__tla as u}from"./constant.C1QLXgsI.js";import{__tla as m}from"./astro/assets-service.BhtN0nM5.js";let s,a,o,t,l,r,i,y=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let e;e=`<h2 id="viewing-component-logs">Viewing Component Logs</h2>
...
<p>When the built-in monitoring suite is not enabled, access logs are recorded together with runtime logs of gateway. Refer to the runtime logs viewing methods above.</p>

import{c as u,__tla as p}from"./astro-component.DdmMvaZ5.js";import{r as l,m,u as g,__tla as d}from"./constant.BXCB4I2h.js";import{__tla as h}from"./astro/assets-service.B3lmwFKy.js";let t,i,o,s,a,c,r,y=Promise.all([(()=>{try{return p}catch{}})(),(()=>{try{return d}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let e;e=`<p>Aliyun ComputeNest is an open PaaS platform for service providers and users that provides software delivery, deployment, and operation process standardization capabilities. It supports the integration of software and resources for one-stop delivery, enabling truly out-of-the-box software usage.

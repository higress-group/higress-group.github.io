import{c,__tla as o}from"./astro-component.BNo6A4i3.js";import{r,m as y,u as E,__tla as v}from"./constant.2GjXjVkh.js";import{__tla as u}from"./astro/assets-service.lesyujvn.js";let a,d,e,n,p,l,i,m=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return v}catch{}})(),(()=>{try{return u}catch{}})()]).then(async()=>{let s;s=`<h2 id="function-description">Function Description</h2>

const e="en/mcp-quick-start.md",t="ai",s="en/mcp-quick-start",r=`
...
`,i={title:"MCP Server Quick Start",description:"Higress AI Gateway provides unified MCP Server hosting capabilities, helping AI Agents quickly integrate with various data sources. Through MCP Server, AI Agents can easily access databases, REST APIs, and other external services without concerning themselves with specific connection details.",keywords:["MCP Server"],date:"2025-04-03",category:"article"},o={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/ai/en/mcp-quick-start.md",rawData:void 0};export{o as _internal,r as body,t as collection,i as data,e as id,s as slug};

import{c as l,r as o,m as p}from"./render-template.CJlwwtnB.js";import{u as d}from"./constant.CxavaNFL.js";import"./preload-helper.BiBI96sQ.js";const s=`<h2 id="edit-the-wasm-file">Edit the Wasm file</h2>
<ol>
...
content-length: 0
\`\`\`
`}function c(){return s}function u(){return[{depth:2,slug:"edit-the-wasm-file",text:"Edit the Wasm file"},{depth:2,slug:"build-the-wasm-image",text:"Build the Wasm image"},{depth:3,slug:"step1-compile-wasm",text:"step1. Compile wasm"},{depth:3,slug:"step2-build-and-push-the-docker-image-of-the-plugin",text:"step2. Build and push the docker image of the plugin"},{depth:2,slug:"enable-wasm-plugin",text:"Enable Wasm plugin"},{depth:3,slug:"using-the-higress-console",text:"Using the Higress console"},{depth:3,slug:"using-crds",text:"Using CRDs"}]}const n=l((g,h,m)=>{const{layout:y,...e}=a;return e.file=i,e.url=t,o`${p()}${d(s)}`});export{n as Content,c as compiledContent,n as default,i as file,a as frontmatter,u as getHeadings,r as rawContent,t as url};

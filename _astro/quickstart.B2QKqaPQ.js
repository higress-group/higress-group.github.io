import{c as d,__tla as c}from"./astro-component.BNo6A4i3.js";import{r,m as E,u as y,__tla as u}from"./constant.BgMVZZKn.js";import{__tla as v}from"./astro/assets-service.lesyujvn.js";let e,l,a,n,p,o,t,g=Promise.all([(()=>{try{return c}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return v}catch{}})()]).then(async()=>{let s;s=`<h2 id="environment-1-use-in-k8s">Environment 1: Use in K8s</h2>

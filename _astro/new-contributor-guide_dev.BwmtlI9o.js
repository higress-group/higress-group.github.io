import{c as o,r as n,m as l}from"./render-template.DKq3LV42.js";import{u as p}from"./index.ZXqh_YvC.js";import"./hooks.module.6Mr8QjZg.js";import"./preact.module.LHOPIhyX.js";import"./jsxRuntime.module.B-HT3-kV.js";import"./preload-helper.BiBI96sQ.js";const s=`<p>This is a guide for new contributor who wants to contribute to Higress.</p>
...
<p>Please check the <a href="https://github.com/alibaba/higress/blob/main/CONTRIBUTING_EN.md" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">CONTRIBUTING.md</a> for code convention.</p>`,t={title:"New contributor guide",keywords:["Higress","contributor"],description:"This is a guide for new comers who wants to contribute to Higress.",custom_edit_url:"https://github.com/higress-group/higress-group.github.io/blob/main/i18n/zh-cn/docusaurus-plugin-content-docs/current/developers/contributor-guide/new-contributor-guide_dev.md"},i="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/developers/contributor-guide/new-contributor-guide_dev.md",a=void 0;function u(){return`
...
`}function c(){return s}function g(){return[{depth:3,slug:"subscribe-to-the-mailing-list",text:"Subscribe to the mailing list"},{depth:3,slug:"reporting-issue",text:"Reporting issue"},{depth:3,slug:"sending-pull-request",text:"Sending pull request"},{depth:3,slug:"code-convention",text:"Code convention"}]}const r=o((d,h,b)=>{const{layout:m,...e}=t;return e.file=i,e.url=a,n`${l()}${p(s)}`});export{r as Content,c as compiledContent,r as default,i as file,t as frontmatter,g as getHeadings,u as rawContent,a as url};

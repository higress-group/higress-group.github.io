const e="latest/en/ops/log.md",s="docs",t="latest/en/ops/log",r=`
# Log Description
...
| x_forwarded_for | string | x-forwarded-for in the HTTP Header, typically used to represent the real IP of the HTTP request client. |`,o={title:"Log Description",description:"Higress Log Description.",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["higress","log"]},a={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/ops/log.md",rawData:void 0};export{a as _internal,r as body,s as collection,o as data,e as id,t as slug};

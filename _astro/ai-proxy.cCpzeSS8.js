import{c as l,__tla as c}from"./astro-component.CwRucF1h.js";import{r,m as u,u as v,__tla as E}from"./constant.BLgJB4oM.js";import{__tla as h}from"./astro/assets-service.Dd3mQuiC.js";let t,o,s,n,d,p,a,y=Promise.all([(()=>{try{return c}catch{}})(),(()=>{try{return E}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let e;e=`<h2 id="function-description">Function Description</h2>
<p><code dir="auto">AI Agent</code> plugin implements AI agent functionality based on OpenAI API contracts. It currently supports AI service providers such as OpenAI, Azure OpenAI, Moonshot, and Qwen.</p>
<blockquote>
...
<h3 id="using-original-protocol-to-proxy-baichuan-ai-agent-application">Using original protocol to Proxy Baichuan AI Agent application</h3>
<p><strong>Configuration Information</strong></p>
...
\`\`\`
`},o=function(){return e},d=function(){return[{depth:2,slug:"function-description",text:"Function Description"},{depth:2,slug:"running-attributes",text:"Running Attributes"},{depth:2,slug:"configuration-fields",text:"Configuration Fields"},{depth:3,slug:"basic-configuration",text:"Basic Configuration"},{depth:3,slug:"provider-specific-configuration",text:"Provider-Specific Configuration"},{depth:4,slug:"openai",text:"OpenAI"},{depth:4,slug:"azure-openai",text:"Azure OpenAI"},{depth:4,slug:"moonshot",text:"Moonshot"},{depth:4,slug:"qwen",text:"Qwen"},{depth:4,slug:"baichuan-ai",text:"Baichuan AI"},{depth:4,slug:"yi",text:"Yi"},{depth:4,slug:"zhipu-ai",text:"Zhipu AI"},{depth:4,slug:"deepseek",text:"DeepSeek"},{depth:4,slug:"groq",text:"Groq"},{depth:4,slug:"baidu",text:"Baidu"},{depth:4,slug:"ai360",text:"AI360"},{depth:4,slug:"mistral",text:"Mistral"},{depth:4,slug:"minimax",text:"MiniMax"},{depth:4,slug:"anthropic-claude",text:"Anthropic Claude"},{depth:4,slug:"ollama",text:"Ollama"},{depth:4,slug:"hunyuan",text:"Hunyuan"},{depth:4,slug:"stepfun",text:"Stepfun"},{depth:4,slug:"cloudflare-workers-ai",text:"Cloudflare Workers AI"},{depth:4,slug:"spark",text:"Spark"},{depth:4,slug:"gemini",text:"Gemini"},{depth:4,slug:"deepl",text:"DeepL"},{depth:4,slug:"cohere",text:"Cohere"},{depth:2,slug:"usage-examples",text:"Usage Examples"},{depth:3,slug:"using-openai-protocol-to-proxy-azure-openai-service",text:"Using OpenAI Protocol to Proxy Azure OpenAI Service"},{depth:3,slug:"using-openai-protocol-to-proxy-qwen-service",text:"Using OpenAI Protocol to Proxy Qwen Service"},{depth:3,slug:"using-original-protocol-to-proxy-baichuan-ai-agent-application",text:"Using original protocol to Proxy Baichuan AI Agent application"},{depth:3,slug:"using-openai-protocol-to-proxy-doubao-large-model-service",text:"Using OpenAI Protocol to Proxy Doubao Large Model Service"},{depth:3,slug:"using-moonshot-with-its-native-file-context",text:"Using Moonshot with its native file context"},{depth:3,slug:"using-openai-protocol-to-proxy-groq-service",text:"Using OpenAI Protocol to Proxy Groq Service"},{depth:3,slug:"using-openai-protocol-to-proxy-claude-service",text:"Using OpenAI Protocol to Proxy Claude Service"},{depth:3,slug:"using-openai-protocol-to-proxy-hunyuan-service",text:"Using OpenAI Protocol to Proxy Hunyuan Service"},{depth:3,slug:"using-openai-protocol-to-proxy-baidu-wenxin-service",text:"Using OpenAI Protocol to Proxy Baidu Wenxin Service"},{depth:3,slug:"using-openai-protocol-to-proxy-minimax-service",text:"Using OpenAI Protocol to Proxy MiniMax Service"},{depth:3,slug:"using-openai-protocol-to-proxy-ai360-service",text:"Using OpenAI Protocol to Proxy AI360 Service"},{depth:3,slug:"using-openai-protocol-to-proxy-cloudflare-workers-ai-service",text:"Using OpenAI Protocol to Proxy Cloudflare Workers AI Service"},{depth:3,slug:"using-openai-protocol-to-proxy-spark-service",text:"Using OpenAI Protocol to Proxy Spark Service"},{depth:3,slug:"using-openai-protocol-to-proxy-gemini-service",text:"Using OpenAI Protocol to Proxy Gemini Service"},{depth:3,slug:"using-openai-protocol-to-proxy-deepl-text-translation-service",text:"Using OpenAI Protocol to Proxy DeepL Text Translation Service"}]},t=l((g,f,x)=>{const{layout:m,...i}=n;return i.file=s,i.url=a,r`${u()}${v(e)}`})});export{t as Content,y as __tla,o as compiledContent,t as default,s as file,n as frontmatter,d as getHeadings,p as rawContent,a as url};

import{c,__tla as o}from"./astro-component.COZxaGv5.js";import{r,m as y,u as E,__tla as v}from"./constant.BcHmsLTn.js";import{__tla as u}from"./astro/assets-service.8AFaQ3Qd.js";let a,d,e,n,p,l,i,m=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return v}catch{}})(),(()=>{try{return u}catch{}})()]).then(async()=>{let s;s=`<h2 id="function-description">Function Description</h2>

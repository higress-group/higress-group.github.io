import{c,__tla as d}from"./astro-component.CXlaF79K.js";import{r,m as E,u as y,__tla as u}from"./constant.DFiws9hU.js";import{__tla as v}from"./astro/assets-service.DQopRnBr.js";let e,l,a,n,p,o,t,g=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return v}catch{}})()]).then(async()=>{let s;s=`<h2 id="environment-1-use-in-k8s">Environment 1: Use in K8s</h2>

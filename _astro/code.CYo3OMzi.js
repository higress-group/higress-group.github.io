import{c as o,r,m as l}from"./render-template.DKq3LV42.js";import{u as p}from"./index.ZXqh_YvC.js";import"./hooks.module.6Mr8QjZg.js";import"./preact.module.LHOPIhyX.js";import"./jsxRuntime.module.B-HT3-kV.js";import"./preload-helper.BiBI96sQ.js";const n=`<p>If you would like to constribute source code for Higress, please check out the <a href="../../developers/guide_dev/" referrerpolicy="unsafe-url">Contribute Guide</a></p>
...
<p>Please be aware that patches will be applied in the order of file names. So please use timestamp as a prefix when naming a new patch file.</p>`,s={title:"Code Reading Instructions",keywords:["higress","coding"],description:"Higress Code Reading Instructions",custom_edit_url:"https://github.com/higress-group/higress-group.github.io/blob/main/i18n/zh-cn/docusaurus-plugin-content-docs/current/dev/code.md"},i="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/dev/code.md",t=void 0;function d(){return`
...
`}function c(){return n}function u(){return[]}const a=o((g,f,h)=>{const{layout:y,...e}=s;return e.file=i,e.url=t,r`${l()}${p(n)}`});export{a as Content,c as compiledContent,a as default,i as file,s as frontmatter,u as getHeadings,d as rawContent,t as url};

const e="latest/en/user/dubbo.md",o="docs",r="latest/en/user/dubbo",t=`
...
For detailed Http2Rpc configuration options, refer to [HTTP to Dubbo Configuration](./dubbo-http2rpc.md).`,s={title:"Higress Dubbo Integration",description:"Integrating Dubbo Services with Higress",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["Dubbo","discovery"]},a={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/user/dubbo.md",rawData:void 0};export{a as _internal,t as body,o as collection,s as data,e as id,r as slug};

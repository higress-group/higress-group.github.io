import{c,__tla as l}from"./astro-component.m4CCZO6J.js";import{r as d,m as u,u as v,__tla as g}from"./constant.vD8sQqEN.js";import{__tla as h}from"./astro/assets-service.BhtN0nM5.js";let e,r,a,n,o,p,i,f=Promise.all([(()=>{try{return l}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let s;s=`<blockquote>
...
<p>Configure the Nacos MCP registry service source in mcpbridge. For detailed configuration information, see the documentation <a href="https://higress.cn/en/docs/latest/user/mcp-bridge/?spm=36971b57.35684624.0.0.4b3d7cdcfQgsaa" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Mcp Bridge Configuration</a></p>
<div class="expressive-code"><figure class="frame not-content"><figcaption class="header"></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#85E89D">registries</span><span style="--0:#E1E4E8">:</span></div></div><div class="ec-line"><div class="code"><span style="--0:#E1E4E8">- </span><span style="--0:#85E89D">domain</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">localhost</span><span style="--0:#E1E4E8">                            </span><span style="--0:#99A0A6"># Address of Nacos, either IP address or domain name</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">mcpServerBaseUrl</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">you_custom_url_prefix</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">name</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">you_custom_name</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">port</span><span style="--0:#E1E4E8">: </span><span style="--0:#79B8FF">8848</span></div></div><div class="ec-line"><div class="code"><span class="indent">  </span><span style="--0:#85E89D">type</span><span style="--0:#E1E4E8">: </span><span style="--0:#9ECBFF">nacos3</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="registries:\x7F- domain: localhost                            # Address of Nacos, either IP address or domain name\x7F  mcpServerBaseUrl: you_custom_url_prefix\x7F  name: you_custom_name\x7F  port: 8848\x7F  type: nacos3"><div></div></button></div></figure></div>
<p>Once configured, you can access MCP services registered in Nacos through Higress. The endpoint for access is http://{higresshost}/you_custom_url_prefix/{service name in Nacos MCP Service configuration}/{access path in Nacos MCP service configuration}.</p>

import{c as p,__tla as l}from"./astro-component.DIa0fJKh.js";import{r as u,m,u as g,__tla as d}from"./constant.D7WnYQd1.js";import{__tla as h}from"./astro/assets-service.tyfV9CK3.js";let t,n,o,s,a,c,i,y=Promise.all([(()=>{try{return l}catch{}})(),(()=>{try{return d}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let e;e=`<p>Aliyun ComputeNest is an open PaaS platform for service providers and users that provides software delivery, deployment, and operation process standardization capabilities. It supports the integration of software and resources for one-stop delivery, enabling truly out-of-the-box software usage.
...
<img src="https://github.com/aliyun-computenest/quickstart-higress/blob/main/docs/img1.jpg" alt="image" referrerpolicy="no-referrer">
...
<img src="https://github.com/aliyun-computenest/quickstart-higress/blob/main/docs/img2.jpg" alt="image" referrerpolicy="no-referrer">
...
<img src="https://github.com/aliyun-computenest/quickstart-higress/blob/main/docs/img3.png" alt="image" referrerpolicy="no-referrer">
Finally, configure the zone. You can create a new VPC or use an existing VPC.
<img src="https://github.com/aliyun-computenest/quickstart-higress/blob/main/docs/img4.png" alt="image" referrerpolicy="no-referrer"></p>
</li>
<li>
...
<img src="https://github.com/aliyun-computenest/quickstart-higress/blob/main/docs/img5.png" alt="image" referrerpolicy="no-referrer">
<img src="https://github.com/aliyun-computenest/quickstart-higress/blob/main/docs/img6.png" alt="image" referrerpolicy="no-referrer"></p>
</li>
</ul>`,s={title:"Rapid deployment through Aliyun ComputeNest",keywords:["deploy","docker compose","docker","ops","aliyun","computenest"],description:"How to Use Aliyun ComputeNest to Rapidly Deploy Higress.",custom_edit_url:"https://github.com/higress-group/higress-group.github.io/blob/main/i18n/en/docusaurus-plugin-content-docs/current/ops/deploy-by-aliyun-computenest.md"},o="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/ops/deploy-by-aliyun-computenest.md",i=void 0,c=function(){return`
...
`},n=function(){return e},a=function(){return[{depth:2,slug:"deployment-steps",text:"Deployment steps"}]},t=p((f,b,v)=>{const{layout:k,...r}=s;return r.file=o,r.url=i,u`${m()}${g(e)}`})});export{t as Content,y as __tla,n as compiledContent,t as default,o as file,s as frontmatter,a as getHeadings,c as rawContent,i as url};

import{c as r,r as n,m as l}from"./render-template.CJlwwtnB.js";import{u as c}from"./constant.CxavaNFL.js";import"./preload-helper.BiBI96sQ.js";const t=`<h1 id="faq">FAQ</h1>
...
***********
`}function d(){return t}function p(){return[{depth:1,slug:"faq",text:"FAQ"}]}const i=r((u,g,f)=>{const{layout:m,...e}=s;return e.file=o,e.url=a,n`${l()}${c(t)}`});export{i as Content,d as compiledContent,i as default,o as file,s as frontmatter,p as getHeadings,h as rawContent,a as url};

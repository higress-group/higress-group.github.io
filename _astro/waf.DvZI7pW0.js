const e="latest/en/user/waf.md",t="docs",s="latest/en/user/waf",i=`
...
The tool helps in assessing the effectiveness of your WAF configuration by simulating various attack vectors and measuring the protection level provided by your security setup.`,a={title:"Best Practices for Enabling WAF Protection",description:"Learn how to enable and configure WAF protection in Higress",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["waf","security","web application firewall"]},n={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/user/waf.md",rawData:void 0};export{n as _internal,i as body,t as collection,a as data,e as id,s as slug};

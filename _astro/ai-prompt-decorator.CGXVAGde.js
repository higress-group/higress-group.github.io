import{c,__tla as d}from"./astro-component.CXlaF79K.js";import{r,m as v,u as E,__tla as y}from"./constant.kwmVrKaU.js";import{__tla as u}from"./astro/assets-service.DQopRnBr.js";let e,p,n,a,l,o,t,F=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return y}catch{}})(),(()=>{try{return u}catch{}})()]).then(async()=>{let s;s=`<h2 id="function-description">Function Description</h2>

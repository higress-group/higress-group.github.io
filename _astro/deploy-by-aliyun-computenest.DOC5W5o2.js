import{c as u,__tla as p}from"./astro-component.B3fYMMDi.js";import{r as l,m,u as g,__tla as d}from"./constant.B9AWHwfy.js";import{__tla as h}from"./astro/assets-service.DmDXK_Mj.js";let t,i,o,s,a,c,r,y=Promise.all([(()=>{try{return p}catch{}})(),(()=>{try{return d}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let e;e=`<p>Aliyun ComputeNest is an open PaaS platform for service providers and users that provides software delivery, deployment, and operation process standardization capabilities. It supports the integration of software and resources for one-stop delivery, enabling truly out-of-the-box software usage.

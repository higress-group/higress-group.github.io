import{c as p,__tla as l}from"./astro-component.DeDyO-JF.js";import{r,m as u,u as v,__tla as h}from"./constant.Bu2T7soS.js";import{__tla as x}from"./astro/assets-service.B3vdYoe2.js";let t,o,a,s,i,c,d,E=Promise.all([(()=>{try{return l}catch{}})(),(()=>{try{return h}catch{}})(),(()=>{try{return x}catch{}})()]).then(async()=>{let e;e=`<h2 id="\u529F\u80FD\u8BF4\u660E">\u529F\u80FD\u8BF4\u660E</h2>
...
<p>\u4F7F\u7528\u5982\u4E0B\u8BF7\u6C42\u7F51\u5173\uFF0C\u5F53\u5F00\u542F <code dir="auto">ext-auth</code> \u63D2\u4EF6\u540E\uFF1A</p>
<div class="expressive-code"><figure class="frame is-terminal not-content"><figcaption class="header"><span class="title"></span><span class="sr-only">Terminal window</span></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#B392F0">curl</span><span style="--0:#E1E4E8"> </span><span style="--0:#79B8FF">-i</span><span style="--0:#E1E4E8"> </span><span style="--0:#9ECBFF">http://localhost:8082/users</span><span style="--0:#E1E4E8"> </span><span style="--0:#79B8FF">-X</span><span style="--0:#E1E4E8"> </span><span style="--0:#9ECBFF">GET</span><span style="--0:#E1E4E8"> </span><span style="--0:#79B8FF">-H</span><span style="--0:#E1E4E8"> </span><span style="--0:#9ECBFF">"foo: bar"</span><span style="--0:#E1E4E8"> </span><span style="--0:#79B8FF">-H</span><span style="--0:#E1E4E8"> </span><span style="--0:#9ECBFF">"Authorization: xxx"</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="curl -i http://localhost:8082/users -X GET -H &#x22;foo: bar&#x22; -H &#x22;Authorization: xxx&#x22;"><div></div></button></div></figure></div>
<p><strong>\u8BF7\u6C42 <code dir="auto">ext-auth</code> \u670D\u52A1\u6210\u529F\uFF1A</strong></p>
<p><code dir="auto">ext-auth</code> \u670D\u52A1\u5C06\u63A5\u6536\u5230\u5982\u4E0B\u7684\u9274\u6743\u8BF7\u6C42\uFF1A</p>
<div class="expressive-code"><figure class="frame not-content"><figcaption class="header"></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">POST /auth HTTP/1.1</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">Host: ext-auth</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">Authorization: xxx</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">Content-Length: 0</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="POST /auth HTTP/1.1\x7FHost: ext-auth\x7FAuthorization: xxx\x7FContent-Length: 0"><div></div></button></div></figure></div>
<p><strong>\u8BF7\u6C42 <code dir="auto">ext-auth</code> \u670D\u52A1\u5931\u8D25\uFF1A</strong></p>
<p>\u5F53\u8C03\u7528 <code dir="auto">ext-auth</code> \u670D\u52A1\u54CD\u5E94\u4E3A 5xx \u65F6\uFF0C\u5BA2\u6237\u7AEF\u5C06\u63A5\u6536\u5230HTTP\u54CD\u5E94\u7801403\u548C <code dir="auto">ext-auth</code> \u670D\u52A1\u8FD4\u56DE\u7684\u5168\u91CF\u54CD\u5E94\u5934</p>
<p>\u5047\u5982 <code dir="auto">ext-auth</code> \u670D\u52A1\u8FD4\u56DE\u4E86 <code dir="auto">x-auth-version: 1.0</code> \u548C <code dir="auto">x-auth-failed: true</code> \u7684\u54CD\u5E94\u5934\uFF0C\u4F1A\u4F20\u9012\u7ED9\u5BA2\u6237\u7AEF</p>
<div class="expressive-code"><figure class="frame not-content"><figcaption class="header"></figcaption><pre tabindex="0"><code><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">HTTP/1.1 403 Forbidden</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">x-auth-version: 1.0</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">x-auth-failed: true</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">date: Tue, 16 Jul 2024 00:19:41 GMT</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">server: istio-envoy</span></div></div><div class="ec-line"><div class="code"><span style="--0:#e1e4e8">content-length: 0</span></div></div></code></pre><div class="copy"><button title="Copy to clipboard" data-copied="Copied!" data-code="HTTP/1.1 403 Forbidden\x7Fx-auth-version: 1.0\x7Fx-auth-failed: true\x7Fdate: Tue, 16 Jul 2024 00:19:41 GMT\x7Fserver: istio-envoy\x7Fcontent-length: 0"><div></div></button></div></figure></div>

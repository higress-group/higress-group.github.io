import{c as l,__tla as d}from"./astro-component.CXlaF79K.js";import{r as p,m as u,u as g,__tla as m}from"./constant.CHkMGfMv.js";import{__tla as y}from"./astro/assets-service.DQopRnBr.js";let s,o,i,n,r,c,a,h=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return m}catch{}})(),(()=>{try{return y}catch{}})()]).then(async()=>{let e;e=`<h1 id="scene-description">Scene Description</h1>
<p>The AI gateway can track the number of tokens used by large models and impose restrictions when consumers exceed their limits, thereby better managing user quotas for AI applications and providing data support for token usage analysis.</p>
...
<p><img src="/img/1742448795176.png" alt="" referrerpolicy="no-referrer"></p>
...
<p><img src="/img/1742448798788.png" alt="" referrerpolicy="no-referrer"></p>
<p>After the deployment is completed, the following command display will appear.</p>
<p><img src="/img/1742448802740.png" alt="" referrerpolicy="no-referrer"></p>
...
<p><img src="/img/1742448806791.png" alt="" referrerpolicy="no-referrer"></p>
<h2 id="configure-consumers">Configure Consumers</h2>
<p>In the consumer management interface of the console, add consumers for the current gateway to manage quotas and send requests.</p>
<p><img src="/img/1742448810781.png" alt="" referrerpolicy="no-referrer"></p>
<p>Click to create a consumer, and based on Key Auth, create three consumers named aliyun-admin, aliyun-user1, and aliyun-user2. Authentication is performed based on the x-api-key field in the HTTP Header.</p>
<p><img src="/img/1742448813965.png" alt="" referrerpolicy="no-referrer"></p>
<p><img src="/img/1742448817304.png" alt="" referrerpolicy="no-referrer"></p>
<h2 id="configure-redis-storage-service">Configure Redis Storage Service</h2>
<p>Token information needs to be temporarily stored for access, so a Redis service needs to be created for caching. This example uses Docker to set up a local Redis service for Higress.</p>
...
<ol>
<li>
<p>Use <code dir="auto">docker network ls</code> to get the ID of the bridge network.
<img src="/img/1742448819882.png" alt="" referrerpolicy="no-referrer"></p>
</li>
<li>
...
<p><img src="/img/1742448822805.png" alt="" referrerpolicy="no-referrer"></p>
<h3 id="configure-redis-service-source">Configure Redis Service Source</h3>
<p>Create a service source in the console\u2019s <code dir="auto">Service Source</code>. Fill in the corresponding fields in the <code dir="auto">Service Source</code>:</p>
<ul>
<li>Type: Domains</li>
<li>Service port: 443</li>
<li>Domains: Concatenate the IP address of my-redis with the service portt</li>
<li>Service protocol: HTTP</li>
</ul>
<p><img src="/img/1742448825899.png" alt="" referrerpolicy="no-referrer"></p>
...
<p>In the <code dir="auto">AI Route</code>, configure consumers for aliyun and click Edit.</p>
<p><img src="/img/1742448829467.png" alt="" referrerpolicy="no-referrer"></p>
<p>Enable request authentication and add the consumers created earlier.</p>
<p><img src="/img/1742448832524.png" alt="" referrerpolicy="no-referrer"></p>
<h3 id="token-quota-configuration">Token Quota Configuration</h3>
<p>In the <code dir="auto">AI Route</code>, configure token quota for aliyun and click Edit.</p>
<p><img src="/img/1742448836119.png" alt="" referrerpolicy="no-referrer"></p>
<p><img src="/img/1742448840018.png" alt="" referrerpolicy="no-referrer"></p>
<p>In the <code dir="auto">AI Quota</code>plugin configuration interface, fill in the following fields as a reference:</p>
...
<p><img src="/img/1742448843302.png" alt="" referrerpolicy="no-referrer"></p>
<h3 id="token-rate-limiting-configuration">Token Rate Limiting Configuration</h3>
<p>In the <code dir="auto">AI Route</code>, configure token rate limit for aliyun and click Edit.</p>
<p><img src="/img/1742448847117.png" alt="" referrerpolicy="no-referrer"></p>
<p><img src="/img/1742448850721.png" alt="" referrerpolicy="no-referrer"></p>
<p>In the <code dir="auto">AI Token Rate Limiting</code> plugin configuration interface, fill in the following fields as a reference:</p>
...
<p><img src="/img/1742448854156.png" alt="" referrerpolicy="no-referrer"></p>
...
<p>Sample response:</p>
<p><img src="/img/1742448859026.png" alt="" referrerpolicy="no-referrer"></p>
<p><img src="/img/1742448862951.png" alt="" referrerpolicy="no-referrer"></p>
...
<p><img src="/img/1742448866900.png" alt="" referrerpolicy="no-referrer"></p>`,n={title:"Token Management",description:"Open-source workflow for token management",date:"2025-03-03",category:"article",keywords:["Higress"],authors:"\u5B50\u91C9"},i="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/ai/en/scene-guide/token-management.md",a=void 0,c=function(){return`
# Scene Description
...
![](/img/1742448813965.png)

![](/img/1742448817304.png)
...
![](/img/1742448836119.png)

![](/img/1742448840018.png)
...
![](/img/1742448859026.png)

![](/img/1742448862951.png)

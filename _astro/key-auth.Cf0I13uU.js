import{c as o,r as d,m as c}from"./render-template.BxWVGK5g.js";import{u as l}from"./index.DVQprq0Y.js";import"./hooks.module.6Mr8QjZg.js";import"./preact.module.LHOPIhyX.js";import"./jsxRuntime.module.B-HT3-kV.js";import"./preload-helper.BiBI96sQ.js";const t=`<h2 id="features">Features</h2>
...
<table><thead><tr><th>HTTP status code</th><th>Error information</th><th>Reason</th></tr></thead><tbody><tr><td>401</td><td>No API key found in request.</td><td>API not provided by request Key.</td></tr><tr><td>401</td><td>Request denied by Key Auth check. Invalid API key.</td><td>Current API Key access is not allowed.</td></tr><tr><td>403</td><td>Request denied by Basic Auth check. Unauthorized consumer.</td><td>The requested caller does not have access.</td></tr></tbody></table>`,a={title:"Key Authentication",keywords:["higress","key auth"],description:"API Key authentication implements the authentication function based on the API Key"},s="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/plugins/authentication/key-auth.md",n=void 0;function r(){return`## Features

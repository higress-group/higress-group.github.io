import{c as d,__tla as p}from"./astro-component.m4CCZO6J.js";import{r as c,m as g,u as h,__tla as u}from"./constant.C798a0v1.js";import{__tla as m}from"./astro/assets-service.BhtN0nM5.js";let s,n,t,a,i,l,o,y=Promise.all([(()=>{try{return p}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let e;e=`<p><a href="https://helm.sh/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Helm</a> is a package manager for Kubernetes used in software management and deployment. You can use Helm to perform a quick install of Higress Gateway in your Kubernetes cluster.</p>
...
\`\`\`
`},n=function(){return e},i=function(){return[{depth:2,slug:"install-higress",text:"Install Higress"},{depth:3,slug:"helm-installation-command",text:"Helm Installation Command"},{depth:3,slug:"installation-parameters",text:"Installation Parameters"},{depth:2,slug:"support-istio-crd",text:"Support Istio CRD"}]},s=d((f,b,E)=>{const{layout:w,...r}=a;return r.file=t,r.url=o,c`${g()}${h(e)}`})});export{s as Content,y as __tla,n as compiledContent,s as default,t as file,a as frontmatter,i as getHeadings,l as rawContent,o as url};

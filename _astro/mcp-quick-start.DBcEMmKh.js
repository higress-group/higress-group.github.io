import{c,__tla as l}from"./astro-component.m4CCZO6J.js";import{r as d,m as v,u,__tla as g}from"./constant.BXZN3hx5.js";import{__tla as h}from"./astro/assets-service.BhtN0nM5.js";let e,r,a,n,p,o,i,y=Promise.all([(()=>{try{return l}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return h}catch{}})()]).then(async()=>{let s;s=`<blockquote>
...
<p>Notes:
The Nacos MCP Registry only exposes services that match the serviceMatcher AND have an mcp-tools configuration file as MCP services. Ensure that the service group and configuration file group are in the same namespace and group.</p>
<ul>

const e="latest/en/plugins/ai/api-dev/ai-search.md",i="docs",t="latest/en/plugins/ai/api-dev/ai-search",r=`
## Feature Description
...
4. Arxiv search doesn't require API key, but you can specify paper category (arxivCategory) to narrow search scope`,a={title:"AI Search Enhancement",description:"Higress supports enhancing the accuracy and timeliness of responses from models like DeepSeek-R1 by integrating real-time results from search engines (Google/Bing/Arxiv/Elasticsearch etc.)",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["higress","ai search"]},n={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/plugins/ai/api-dev/ai-search.md",rawData:void 0};export{n as _internal,r as body,i as collection,a as data,e as id,t as slug};

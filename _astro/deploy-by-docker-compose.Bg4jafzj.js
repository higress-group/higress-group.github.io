import{c,__tla as d}from"./astro-component.B3fYMMDi.js";import{r as p,m as g,u as h,__tla as u}from"./constant.B9AWHwfy.js";import{__tla as y}from"./astro/assets-service.DmDXK_Mj.js";let t,r,s,o,i,l,n,m=Promise.all([(()=>{try{return d}catch{}})(),(()=>{try{return u}catch{}})(),(()=>{try{return y}catch{}})()]).then(async()=>{let e;e=`<p>Docker Compose is a tool for defining and running multi-container Docker applications. With it, we can use YAML files to deploy Higress gateway standalone without a K8s cluster.</p>
<blockquote>

import{c,__tla as o}from"./astro-component.CXlaF79K.js";import{r,m as v,u as E,__tla as y}from"./constant.Dh5VMQWp.js";import{__tla as F}from"./astro/assets-service.DQopRnBr.js";let e,p,a,n,l,d,t,x=Promise.all([(()=>{try{return o}catch{}})(),(()=>{try{return y}catch{}})(),(()=>{try{return F}catch{}})()]).then(async()=>{let s;s=`<h2 id="functional-description">Functional Description</h2>

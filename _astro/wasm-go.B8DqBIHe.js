...
\`\`\`
`,r={title:"Developing WASM Plugins with Go",description:"A comprehensive guide to developing WASM plugins for Higress using the Go programming language",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["wasm","go","golang","plugin","development"]},n={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/user/wasm-go.md",rawData:void 0};export{n as _internal,o as body,t as collection,r as data,e as id,s as slug};

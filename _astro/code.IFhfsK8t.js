import{c as p,__tla as c}from"./astro-component.m4CCZO6J.js";import{r as d,m as u,u as g,__tla as f}from"./constant.Cqgoy52h.js";import{__tla as y}from"./astro/assets-service.BhtN0nM5.js";let n,o,s,t,r,l,i,h=Promise.all([(()=>{try{return c}catch{}})(),(()=>{try{return f}catch{}})(),(()=>{try{return y}catch{}})()]).then(async()=>{let e;e=`<p>If you would like to constribute source code for Higress, please check out the <a href="../../developers/guide_dev/" referrerpolicy="unsafe-url">Contribute Guide</a></p>
...
<p>Please be aware that patches will be applied in the order of file names. So please use timestamp as a prefix when naming a new patch file.</p>`,t={title:"Code Reading Instructions",keywords:["higress","coding"],description:"Higress Code Reading Instructions",custom_edit_url:"https://github.com/higress-group/higress-group.github.io/blob/main/i18n/zh-cn/docusaurus-plugin-content-docs/current/dev/code.md"},s="/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/dev/code.md",i=void 0,l=function(){return`
...
`},o=function(){return e},r=function(){return[]},n=p((v,m,E)=>{const{layout:b,...a}=t;return a.file=s,a.url=i,d`${u()}${g(e)}`})});export{n as Content,h as __tla,o as compiledContent,n as default,s as file,t as frontmatter,r as getHeadings,l as rawContent,i as url};

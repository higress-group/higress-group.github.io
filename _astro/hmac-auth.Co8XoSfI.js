const e="latest/en/plugins/authentication/hmac-auth.md",t="docs",a="latest/en/plugins/authentication/hmac-auth",n=`
...
`,i={title:"HMAC authentication",description:"HMAC authentication implements the generation of tamper-proof signatures for HTTP requests based on HMAC algorithm, and uses the signature for identity authentication and authorization.",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["higress","hmac"]},r={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/plugins/authentication/hmac-auth.md",rawData:void 0};export{r as _internal,n as body,t as collection,i as data,e as id,a as slug};

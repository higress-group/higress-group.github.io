import{c as u,__tla as c}from"./astro-component.DtWAgCJT.js";import{r as h,m as p,u as d,__tla as g}from"./constant.D-aE-7Mt.js";import{__tla as m}from"./astro/assets-service.BMxLt3pn.js";let i,a,t,o,n,l,r,f=Promise.all([(()=>{try{return c}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return m}catch{}})()]).then(async()=>{let e;e=`<p>It is warmly welcomed if you have interest to hack on Higress. First, we encourage this kind of willing very much. And here is a list of contributing guide for you.</p>

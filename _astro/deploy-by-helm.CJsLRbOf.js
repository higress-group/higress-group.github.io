...
\`\`\`
`}function c(){return e}function g(){return[{depth:2,slug:"install-higress",text:"Install Higress"},{depth:3,slug:"helm-installation-command",text:"Helm Installation Command"},{depth:3,slug:"installation-parameters",text:"Installation Parameters"},{depth:2,slug:"support-istio-crd",text:"Support Istio CRD"}]}const n=r((h,u,m)=>{const{layout:y,...s}=t;return s.file=a,s.url=o,i`${l()}${d(e)}`});export{n as Content,c as compiledContent,n as default,a as file,t as frontmatter,g as getHeadings,p as rawContent,o as url};

import{c as p,__tla as c}from"./astro-component.m4CCZO6J.js";import{r as d,m as u,u as h,__tla as g}from"./constant.BIcsxUkJ.js";import{__tla as y}from"./astro/assets-service.BhtN0nM5.js";let s,o,a,t,i,l,n,f=Promise.all([(()=>{try{return c}catch{}})(),(()=>{try{return g}catch{}})(),(()=>{try{return y}catch{}})()]).then(async()=>{let e;e=`<p>This guide provides a quick deployment method for the Higress AI Gateway using <strong>Docker</strong>. If you need to use other deployment methods (such as standard Kubernetes clusters or local Kubernetes clusters), please refer to the <a href="https://higress.cn/en/docs/latest/user/quickstart/" referrerpolicy="unsafe-url" rel="nofollow" target="_blank">Quick Start</a>.</p>

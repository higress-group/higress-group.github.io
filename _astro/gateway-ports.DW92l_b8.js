const t="latest/en/ops/how-tos/gateway-ports.md",s="docs",e="latest/en/ops/how-tos/gateway-ports",o=`
...
\`\`\`shell
  ...
  hgctl install --set profile=local-docker --set gateway.httpPort=8080 --set gateway.httpsPort=8443`,a={title:"Modify Gateway Listening Ports",description:"Introduce how to make Gateway listen to ports other than 80 and 443",editUrl:!0,head:[],template:"doc",sidebar:{hidden:!1,attrs:{}},pagefind:!0,keywords:["ops","config","route","tcp"]},n={type:"content",filePath:"/home/runner/work/higress-group.github.io/higress-group.github.io/src/content/docs/latest/en/ops/how-tos/gateway-ports.md",rawData:void 0};export{n as _internal,o as body,s as collection,a as data,t as id,e as slug};
